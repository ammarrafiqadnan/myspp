            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data=='OK'){
                        swal({
                          title: 'Berjaya',
                          text: 'Maklumat telah berjaya didaftarkan.',
                          type: 'success',
                        ...
                        swal({
                          title: 'Amaran',
                          text: 'Pemohon telah berdaftar dalam sistem MySPP.',
                          type: 'error',
                          confirmButtonClass: "btn-warning",
                          confirmButtonText: "Ok",
                          showConfirmButton: true,
                        });
		    } else if(data=='ICDAHDAFTAR'){
			swal({
                          title: 'Amaran',
                          text: 'Maaf permohonan tidak berjaya. No. Kad Pengenalan telah didaftarkan dengan emel yang berbeza.',
                          type: 'error',
                          confirmButtonClass: "btn-warning",
                          confirmButtonText: "Ok",
                          showConfirmButton: true,
			  //position: "top",  
                        ...
                        swal({
                          title: 'Amaran',
                          text: 'Pemohon belum berdaftar dengan sistem MySPP.\nSila buat pendaftaran permohonan terlebih dahulu.',
                          type: 'error',
                          confirmButtonClass: "btn-warning",
                          confirmButtonText: "Ok",
                          showConfirmButton: true,
    ...
    <section class="bg-white big-banner panel panel-featured panel-featured-info" style="min-height: 630px;">
        ...
        <div class="container pt-5" style="opacity: 0.9;">
            ...
            <div class="card p-5 text-md-left">
                <h1 class="card-title text-center">PENDAFTARAN PEMOHON mySPP</h1>

		<div class="modal-body">
                    <div class="col-md-12">    
                        <div class="form-group my-12">
                            <div class="row" align="center">
                                <label class="col-md-12"><b>Sila buat pendaftaran semula.</b></label>
...
<div class="col-md-12">
    <section class="bg-white big-banner panel panel-featured panel-featured-info" style="min-height: 630px;">
        ...
        <div class="container pt-5" style="opacity: 0.9;">
            ...
            <div class="card p-5 text-md-left">
                <h1 class="card-title text-center">PENGAKTIFAN AKAUN PENDAFTARAN mySPP</h1>
                ...
                <div class="modal-body">
                    <div class="col-md-12">    
                        ...
                        <div class="form-group my-3">
                            <div class="row">
                                <label class="col-md-3"><b>Kata Laluan : <font color="#f00">*</font></b>
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-outline-info btn-md" onclick="do_register1('module/daftar_proses.php?pro=REG')">Hantar <i class="fas fa-save ml-1"></i></button>
