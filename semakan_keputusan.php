	...
	include '/var/www/html/myspp/connection/common.php';
        ...
        $hrefs = 'index.php?pages=semakan_keputusan';
	print $hrefs;
...
<section id="intro" class="bg-white big-banner" style="min-height: 630px;">
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="text-center py-3">
						<h3>Semakan Keputusan Temu Duga</h3>
					</div>
					<div class="card-body d-flex flex-column">
						<div class="box-body" style="">
							<div class="row" align="">
								...
								<div class="col-md-5">
									<input type="text" id="carian" name="carian" value="<?=$carian;?>" class="form-control" placeholder="No. Kad Pengenalan">
								</div>
	...
	$sqlD = "SELECT * FROM $schema2.`senarai_keputusan_temuduga` WHERE `noKP`=".tosql($carian)." AND is_deleted=0";
	$rsD = $conn->query($sqlD);
	...
	?>
        ...
        <div class="container pt-5" style="opacity: 0.9;">
            ...
            <div class="row d-flex justify-content-center align-items-center">
				...
				<div class="col-md-2" align="left">
                                        <a href="index.php?pages=semakan_keputusan" type="button" class="btn btn-outline-info"><i class="fa fa-spinner"></i> Carian Semula</a>                                    
                                </div> 
                                <br><br>
				    ...
				    //$conn->debug=true;
							 ...
							 if($rs->fields['kod_skim'] == '4321'){
				    				$href_cetakB = "_msys/modal_print.php?win=".base64_encode('cetakan/cetak_keputusan.php;'.$carian);
				    			 } else if($rs->fields['kod_skim'] == '4000'){ 
				    				$href_cetakB = "_msys/modal_print.php?win=".base64_encode('cetakan/cetak_keputusan_DG.php;'.$carian);
				    			 } else if($rs->fields['kod_skim'] == '5000'){
				    				$href_cetakB = "_msys/modal_print.php?win=".base64_encode('cetakan/cetak_keputusan­_DH.php;'.$carian);
				    			 } 
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-10"><?=displayDate($rs->fields['tarikh']); ?></div>
                                                                </div>
                                                            </div><br>
                                                            <div class="form-group">
                                                                <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-sm-12" style="text-align: justify;">
                                                                        ...
                                                                        Sila klik di <a href="#" onclick="do_cetak3('<?=$href_cetakB;?>')">sini</a> untuk mencetak Surat Tawaran dan Pakej Setuju Terima Tawaran (PSTT). <br><br>
                                                                        ...
                                                                        Ibu Pejabat: <a href="mailto:guru@spp.gov.my">guru@spp.gov.my</a> / <a href="mailto:bukanguru@spp.gov.my">bukanguru@spp.gov.my</a><br><br>

                                                                        Urus Setia SPP Sarawak: <a href="mailto:pengambilan.sarawak@spp.gov.my">pengambilan.sarawak@spp.gov.my</a>
                                                                        <br><br>

                                                                        Urus Setia SPP Sabah: <a href="mailto:uscsabah@spp.gov.my">uscsabah@spp.gov.my</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                               ...
                                               $rs->movenext(); }
                                                ...
                                                print '<div align="center"><br><h4><b>Maaf! Permohonan anda tidak berjaya.</b></h4></div>';
                                            }
                                        //} else {
