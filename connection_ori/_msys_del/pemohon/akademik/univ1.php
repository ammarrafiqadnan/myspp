...
<div class="form-group">
	<div class="row">
		<div class="col-sm-8">
			...
			<?php $rfKelulusan = $conn->query("SELECT * FROM $schema1.`ref_kelayakan` WHERE SAH_YT='Y' ORDER BY `DISKRIPSI`"); ?>
			<div class="form-group">
				<div class="row">
			...
			<?php $rsKhusus = $conn->query("SELECT * FROM $schema1.`ref_pengkhususan` WHERE `JENIS` IN (1,2,3) ORDER BY `DISKRIPSI` ASC "); ?>
			<div class="form-group">
				<div class="row">
