...
<?php 
    ...
    //         } else if($sort == 'down'){
    //             $sSQL1 .= " ORDER BY A.nama_penuh DESC";
    //         }
    //     } 
        
    //     if($order_by == 'noKP'){
    //         if($sort == 'up'){
    //             $sSQL1 .= " ORDER BY A.ICNo ASC";
    //         } else if($sort == 'down'){
    //             $sSQL1 .= " ORDER BY A.ICNo DESC";
    //         }
    //     }

    //     if($order_by == 'negeri'){
    //         if($sort == 'up'){
    //             $sSQL1 .= " ORDER BY B.diskripsi2 ASC";
    //         } else if($sort == 'down'){
    //             $sSQL1 .= " ORDER BY B.diskripsi2 DESC";
    //         }
    //     }

    //     if($order_by == 'status'){
    //         if($sort == 'up'){
    //             $sSQL1 .= " ORDER BY A.pengakuan ASC";
    //         } else if($sort == 'down'){
    //             $sSQL1 .= " ORDER BY A.pengakuan DESC";
    //         }
    //     }
    // } else {
        $sSQL1 .= " ORDER BY A.nama_penuh ASC";
