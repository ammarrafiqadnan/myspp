...
<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
    <h6 class="panel-title"><font color="#000000" size="3"><b>MAKLUMAT REKACIPTA/PENCAPAIAN CALON</b></font></h6>
</header>
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <?php 
                                ...
                                while(!$rsRekacipta->EOF){ 
                                    $sql = "SELECT * FROM $schema1.`ref_rekacipta` WHERE SAH_YT='Y' KOD=".tosql($rsRekacipta->fields['jawatan'])." ORDER BY KOD";
                                    $rsReka = $conn->query($sql);

                                    $sql = "SELECT * FROM $schema1.`ref_peringkat` WHERE SAH_YT='Y' kod=".tosql($rsRekacipta->fields['jawatan'])." ORDER BY KOD";
