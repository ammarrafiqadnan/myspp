...
<script>
	function do_save(){
		...
		swal({
			title: 'Adakah anda pasti untuk menutanaik data bagi urusan rayuan temuduga?',
			...
			$.ajax({
				url:'muatnaikExcel/sql_muatnaikExcel.php?frm=RAYUAN_TEMUDUGA&pro=UPLOAD',
				type:'POST',
				//dataType: 'json',
				beforeSend: function () {
	...
	<section class="panel">
		...
		<div class="panel-body">
			<div class="box-body">
			    ...
			    <input type="hidden" name="kod_rayuan_temuduga" id="kod_rayuan_temuduga" value="<?php print $rs->fields['kod']; ?>">
