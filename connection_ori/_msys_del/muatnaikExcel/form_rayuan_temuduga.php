...
<script>
	function do_save(){
		...
		if (tajuk.trim() == '' ){
			...
			$.ajax({
				url:'muatnaikExcel/sql_muatnaikExcel.php?frm=RAYUAN_TEMUDUGA&pro=SAVE',
				type:'POST',
				//dataType: 'json',
				// beforeSend: function () {
...
<?php
	...
	//print $kod;
	$sql3 = "SELECT * FROM $schema2.`rayuan_temuduga` WHERE kod='{$kod}'";
	$rs = $conn->query($sql3);
?>
<div class="col-lg-12">
	<section class="panel">
		<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
			...
			<h6 class="panel-title"><font color="#000000" size="3"><b>TAMBAH MAKLUMAT RAYUAN TEMU DUGA</b></font></h6>
		</header>
		<div class="panel-body">
			<div class="box-body">

			    <input type="hidden" name="kod_rayuan_temuduga" id="kod_rayuan_temuduga" value="<?php if(!empty($kod)){ print $rs->fields['kod'];} ?>">
