...
const chart = Highcharts.chart('container', {
    ...
    title: {
        text: 'Maklumat pemantauan berdasarkan kategori bagi tahun',
        align: 'left'
    },
    subtitle: {
...
locations.forEach(location => {
    ...
    btn.addEventListener('click', () => {
        ...
        chart.update({
            title: {
                text: 'Jumlah Pemantauan Bagi Tahun ' + location.year 
            },
            subtitle: {
