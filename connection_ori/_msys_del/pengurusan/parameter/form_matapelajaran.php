...
<?php
	...
	$sql3 = "SELECT * FROM $schema1.`ref_jenis_matapelajaran` WHERE kod='{$matapelajaran_kod}'";
	$rs = $conn->query($sql3);
?>
<div class="col-lg-12">
	<section class="panel">
		<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
			...
			<h6 class="panel-title"><font color="#000000" size="3"><b>TAMBAH MAKLUMAT MATAPELAJARAN</b></font></h6>
		</header>
		<div class="panel-body">
			<div class="box-body">
				...
				<div class="col-md-12">
                    ...
                    <div class="form-group">
						<div class="row">
							<label for="no_pemerolehan" class="col-sm-3 control-label"><b>No. Pemerolehan <font color="#FF0000">*</font> : </b></label>
							<div class="col-sm-9">
								<input type="text" name="no_pemerolehan" id="no_pemerolehan" class="form-control" value="<?php if(!empty($matapelajaran_kod)){ print $rs->fields['diskripsi']; } ?>">
							</div>
						</div>
					</div>
