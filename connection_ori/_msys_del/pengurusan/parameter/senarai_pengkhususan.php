...
<div class="box" style="background-color:#F2F2F2">
    ...
    <div class="col-md-12" align="right">
        <a href="pengurusan/parameter/form_pengkhususan.php?pengkhususan_kod=" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Notifikasi">
    ...
    <div class="box-body" style="background-color:#F2F2F2">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead  style="background-color:rgb(38, 167, 228)">
                ...
                <th width="40%"><font color="#000000"><div align="center">Pengkhususan</div></font></th>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="pengurusan/parameter/form_pengkhususan.php?pengkhususan_kod=<?=$rs->fields['kod'];?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal" title="Kemaskini Maklumat Bangsa">
