...
<script>
    function sortorder(href, bidang){
        // alert('sini');   
        var cari = $('#carian').val();
...
<?php
    ...
    $sql3 = "SELECT A.*, B.DISKRIPSI FROM $schema1.padanan_bidang_pengkhususan A, $schema1.`ref_pengkhususan` B WHERE A.kod_pengkhususan=B.kod AND A.status=0";
...
<div class="box" style="background-color:#F2F2F2">
    ...
    <div class="box-body" style="height: 40px;background-color:#F2F2F2;">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                ?>
                <select name="bidang" id="bidang" class="form-control" onchange="sortorder('<?=$hrefs;?>', this.value)">
    ...
    <div class="col-md-12" align="right">
        <a href="pengurusan/parameter/form_padananBidangPengkhususan.php?bidang_kod=<?=$bidang;?>" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Notifikasi">
