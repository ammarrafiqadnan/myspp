...
<?php
    ...
    $sql3 = "SELECT A.*, B.DISKRIPSI FROM $schema1.padanan_peringkatakademik_skim A, $schema1.`ref_skim` B WHERE A.kod_skim=B.KOD AND A.status=0";
...
<div class="box" style="background-color:#F2F2F2">
    ...
    <div class="col-md-12" align="right">
        <a href="pengurusan/parameter/form_padananAkademikSkim.php?peringkat2=<?=$peringkat2;?>" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Notifikasi">
