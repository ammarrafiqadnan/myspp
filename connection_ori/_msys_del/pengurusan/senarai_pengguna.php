		...
		<div class="box" style="background-color:#F2F2F2">
            ...
            <div class="box-body" style="height: 40px;background-color:#F2F2F2;">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <select name="bahagian" id="bahagian" class="form-control"  onchange="sortorder('<?=$hrefs;?>',this.value)">
                    ...
                    <div class="col-md-5">
                        <select select name="jawatan" id="jawatan" class="form-control"  onchange="sortorder('<?=$hrefs;?>',this.value)">
            ...
            <div class="box-body" style="height: 40px;background-color:#F2F2F2;">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <select name="peranan" id="peranan" class="form-control"  onchange="sortorder('<?=$hrefs;?>',this.value)">
                            <option value="">-- Sila pilih peranan --</option>
                            <option value="1" <?php if($peranan == 1){ print 'selected'; } ?>>Pentadbir</option>
                            <option value="2" <?php if($peranan == 2){ print 'selected'; } ?>>Meja Bantu</option>
                    ...
                    <div class="col-sm-3">
                        <select name="status" id="status" class="form-control"  onchange="sortorder('<?=$hrefs;?>',this.value)">
			...
			<div class="box-body" style="background-color:#F2F2F2">
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead  style="background-color:rgb(38, 167, 228)">
                        ...
                        <th width="25%"><font color="#000000"><div align="center">Nama Penuh/ No.KP</div></font></th>
                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <?php 
                                    if($rs->fields['bahagian'] == 1){
                                        print 'BAHAGIAN TEKNOLOGI MAKLUMAT';
                                    } else if($rs->fields['bahagian'] == 2){
                                        print 'BAHAGIAN TEMUDUGA';
                                    }
                                ?>
                            </td>
                            <td align="left">
                            ...
                            <td align="center">
                                ...
                                <a href="pengurusan/pengguna_form.php?id=<?=$rs->fields['id'];?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal" title="Kemaskini Maklumat Pengguna">
                                    <i class="fa fa-edit"></i>
                                </a>
