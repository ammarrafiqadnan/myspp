			...
			<div class="box-body" style="background-color:#F2F2F2">
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead  style="background-color:rgb(38, 167, 228)">
                        ...
                        <th width="15%"><font color="#000000"><div align="center">Jenis</div></font></th>
                        <th width="45%"><font color="#000000"><div align="center">Tajuk</div></font></th>
                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="pengurusan/hebahan_maklumat_form.php?id=<?=$rs->fields['kod'];?>&jenis=edit" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal-xl" title="Kemaskini Maklumat Hebahan">
                                ...
                                <button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('pengurusan/sql_pengurusan.php?frm=PENGURUSAN&pro=HAPUS&jenis=HEBAHAN_MAKLUMAN&id_hapus=<?=$rs->fields['kod'];?>')">
                                    <span style="cursor:pointer;color:red" title="Hapus maklumat hebahan"><i class="fa fa-trash-o" style="color: #FFFFFF;"></i></span>
                                </button>
                            </td>
                        </tr>
                        <?php 
