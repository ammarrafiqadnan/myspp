...
<div class="box" style="background-color:#F2F2F2">
    ...
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Senarai Maklumat Kod Kluster</b></font></h6> 
    </header>
    </div>
    </div>            
    <br /> 
    <div class="box-body" style="height: 40px;background-color:#F2F2F2;">
        <div class="row">
            ...
            <div class="col-md-5" style="background-color:#F2F2F2">
                <input type="text" name="carian" value="" class="form-control" placeholder="Pengajian Tinggi">
            </div>
    ...
    <div class="col-md-12" align="right">
        <a href="pengurusan/kod_kluster/form_kod_kluster.php?id=" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Notifikasi">
        ...
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <?php 
                ...
                <tr>
                    ...
                    <!-- <td align="center">
                        <?php 
                            if($rs->fields['tahap_pendidikan'] == 1){
                                print 'Sekolah Menengah ISM (Pendidikan)';
                            } else if($rs->fields['tahap_pendidikan'] == 2) {
                                print 'Sekolah Menengah ISM (Umum)';
                            } else if($rs->fields['tahap_pendidikan'] == 3) {
                                print 'Sekolah Rendah ISM (Pendidikan)';
                            } else if($rs->fields['tahap_pendidikan'] == 4) {
                                print 'Sekolah Menengah ISM (Umum)';
                            }
                        ?>
                    </td> -->
                    ...
                    <td align="center">
                        <a href="pengurusan/kod_kluster/form_kod_kluster.php?kluster_kod=<?=$rs->fields['kod'];?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal" title="Kemaskini Maklumat Bangsa">
