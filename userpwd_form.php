...
function do_simpan(){
    ...
    if(noKP.trim() == '' ){
		alert('Sila masukkan maklumat No. Kad Pengenalan Anda');
		$('#noKP').focus(); return false;
    } else if(email.trim() == '' ){
		alert('Sila masukkan maklumat emel anda');
				...
				$.ajax({
					...
					success: function(data){
						...
						if(data=='OK'){
							...
							swal({
							  title: 'Amaran',
							  text: 'Emel yang dimasukkan tidak sama seperti yang didaftarkan.',
							  type: 'error',
							...
							swal({
							  title: 'Amaran',
							  text: 'Maklumat No. kad pengenalan anda salah.\nMaklumat anda tidak berjaya dikemaskini.',
							  type: 'error',
							  confirmButtonClass: "btn-warning",
							  confirmButtonText: "Ok",
							  showConfirmButton: true,
    ...
    <div class="panel-body">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
            	<div class="row">
                <label class="col-sm-4 control-label" style="color: #000;"><font color="#FF0000">*</font>No Kad Pengenalan: </label>
                <div class="col-sm-3">
			...
			<div class="form-group">
            	<div class="row">
                <label class="col-sm-4 control-label" style="color: #000;"><font color="#FF0000">*</font>Alamat Emel : </label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
            	<div class="row">
                <label class="col-md-4 control-label" style="color: #000;"><font color="#FF0000">*</font> Katalaluan Baru :</label>
            ...
            <div class="form-group">
            	<div class="row">
                <label class="col-md-4 control-label" style="color: #000;"><font color="#FF0000">*</font> Ulang Katalaluan Baru :</label>
                <div class="col-md-4 control-label">
