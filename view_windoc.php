...
if(!empty($applicant_id)){ 
    $jfiles="../uploads/doc/".$applicant_id."/".$doc;
} else {
    $jfiles="../uploads/doc/".$doc;
}
//print $jfiles;
...
<div class="modal-header bg-primary">
    ...
    <div style="float:right;margin-top:-15px"><button type="button" onclick="closeWin()">&times;</button></div>
</div>
...
<div class="modal-body">
    <div class="col col-md-12 well">
        <div class="form-group row">
            <div class="col-sm-12">
        <?php if($ext=='jpg' || $ext=='gif' || $ext=='png' || $ext=='jpeg' || $ext=='PNG') { ?>
...
<div class="modal-footer">
    <button type="button" class="btn btn-default"  onclick="closeWin()">Tutup</button>
</div>
