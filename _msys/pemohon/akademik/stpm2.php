...
<?php
    ...
    $tahun_stp = $data->fields['stp_tahun_2'];
	//$conn->debug=true;
...
?>
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <?php while(!$rssijil->EOF){ ?>
                    <?php if($rssijil->fields['KOD']==$data->fields['stp_jenis_2']){ 
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <?php while(!$rspangkat->EOF){ ?>
                    <?php if($rspangkat->fields['DISKRIPSI']==$data->fields['stp_pangkat_2']){ 
    ...
    <hr>
	<?php //$conn->debug=true;
	if(!empty($data->fields['stp_tahun_2'])){ 
        ...
        <div class="col-sm-8">
			...
			<tr>
				...
				<td align="center">
					<?php 
					//$conn->debug=true;
							$s_tahun = $data->fields['stp_tahun_2'];
