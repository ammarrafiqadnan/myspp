...
$tahun = $data->fields['stam_tahun_1'];
...
<small style="color: red;">
		...
		<div class="row">
			...
			<div class="col-sm-2">
					<?php for($t=date("Y");$t>=1985;$t--){
						if($data->fields['stam_tahun_1']==$t){ print $t; }
			...
			<div class="col-sm-2">
					...
					<?php if($rspangkat->fields['KOD']==$data->fields['stam_pangkat_1']){ print $rspangkat->fields['DISKRIPSI'];} ?>
	...
	<?php 
	// $conn->debug=true;
	if(!empty($data->fields['stam_tahun_1'])){ 
