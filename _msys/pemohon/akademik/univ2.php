...
<div class="form-group">
	<div class="row">
		<div class="col-sm-8">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-3"><?php print displayDate($rsUniv->fields['tkh_senate']);?>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
                            ...
                            <?php if( $rfMajor->fields['KOD'] == $rsUniv2->fields['MAJOR'] ){ 
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
                            ...
                            <?php if( $rfMinor->fields['KOD'] == $rsUniv2->fields['MINOR'] ){ 
				...
				<div class="row">
					...
					<div class="col-sm-8">
        					<?php while(!$rsJP->EOF){ $code = $rsJP->fields['kod']; ?>    
            					<?php if($rsUniv2->fields['muet']==$code){ print $rsJP->fields['diskripsi']; }?>
        					<?php $rsJP->movenext(); } ?>
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<?php for($i=$d; $i>='1999'; $i--){ ?>
                   					<?php if($rsUniv2->fields['muet_tahun']==$i){ print $i; }?>                    				<?php } ?>					
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-7">
							...
							?>    
            						<?php if($rsUniv2->fields['muet_gred']==$code){ print $kep; }?>
        					<?php $rsJK->movenext(); } ?>
					</div>
		...
		$rsSijil31 = $conn->query("SELECT * FROM $schema2.`calon_sijil` WHERE `jenis_sijil`='UNIV2C' AND `id_pemohon`=".tosql($uid));
		?>
		...
		<div class="col-sm-4" align="center">
			...
			<?php if(empty($rsSijil31->fields['sijil_nama'])){ 
				...
				<a href="#" onclick="return popitup('../view_doc_pemohon.php?id_pemohon=<?=$uid;?>&doc=<?=$rsSijil31->fields['sijil_nama'];?>')">
				<?=$rsSijil31->fields['sijil_nama'];?></a>
		...
		<div class="col-sm-4" align="center">
			...
			<?php if (file_exists($sijil_pic2)){ print "<br><div>".$rsSijil2->fields['sijil_nama']."</div>"; } ?>
		</div>
