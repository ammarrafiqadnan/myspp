...
if($prn=='WORD'){
	...
	header("content-disposition: attachment;filename=word-".date('Ymd').".doc");
} else if($prn=='EXCEL'){
	header("Content-Type: application/vnd.ms-excel");
	header("Expires: 0");
	header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
	header("content-disposition: attachment;filename=excel-".date('Ymd').".xls");
}
?>
<html>
<head>
...
<!-- <div class="divHeader" style="width:100%">
	<table width="98%" border=0>
  	<tr>
      	...
      	<td width="20%" align="right" valign="middle"><img src="images/logo_spp.png" width="80" height="80" /></td>
      </tr>
  </table>
</div> -->
<div class="divFooter">
	<table width="97%" border=0>
		<tr>
			<td align="left"><i>Dicetak oleh <?=$_SESSION['SESSADM_UNAME'];?> pada <?=date("d/m/Y");?></i></td>
