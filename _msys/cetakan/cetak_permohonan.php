...
$data = file_get_contents('../assets/images/logoSPP.png');
...
<table width="90%" cellpadding="5" cellspacing="0" border="1" align="center" style="border-style: solid;">
		<tr>
        	<td width="100%" valign="top" align="center" style="padding-left:30px; padding-right:30px; padding-top:20px;">
                <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                    ...
                    <tr>
			<td width="20%">
				<img src="'.$base64.'" style="width:130px;" height="95px"  alt="base" />
			<td>
                        <td width="80%">
		...
		<table width="100%" cellpadding="3" cellspacing="0" border="1" align="center">
			<tr style="height: 10px;">
				<th width="100%" align="center"><h3>MAKLUMAT TEMU DUGA</h3></th>
