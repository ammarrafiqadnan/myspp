...
<div class="card card-danger">
  ...
  <div class="card-body">
    <canvas id="pieChart_det1" style="min-height: 150px; height: 150px; max-height: 150px; max-width: 150px;"></canvas>
  </div>
  <!-- /.card-body -->
</div>
...
// print $start_dt;
$sql = "SELECT COUNT(*) as nilai FROM $schema2.calon_jawatan_dipohon A  WHERE peringkat IN('DIPLOMA','IJAZAH')";
...
$sql2 = "SELECT COUNT(*) as nilai FROM $schema2.calon_jawatan_dipohon A  WHERE peringkat IN('SPM','PMR/PT3')";
...
<script type="text/javascript">
  $(function () {
    ...
    var pieChartCanvas = $('#pieChart_det1').get(0).getContext('2d')
...
<b>Nota:</b><br>
  ...
  print '<label style="color:#f39c12"><b>DG & DH : '. number_format($rsIkhtisas->fields['nilai'],0)." Permohonan (".number_format($pct1,2)."%)</b></label><br>"; 
  print '<label style="color:#00c0ef"><b>AKP : '.number_format($rsBukanIkhtisas->fields['nilai'],0)." Permohonan (".number_format($pct2,2)."%)</b></label><br>"; 
 ?>