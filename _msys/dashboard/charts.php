...
<script type="text/javascript">
 ...
 // var data = [{
 //            data: [<?=$rsIkhtisas->fields['nilai'];?>, <?=$rsBukanIkhtisas->fields['nilai'];?>],
 //            labels: ['Ikhtisas','Bukan Ikhtisas',],
 //            backgroundColor: [
 //                "#4b77a9",
 //                "#5f255f",
 //                "#d21243",
...
<b>Nota:</b><br>
  ...
  print '<label style="color:#f39c12"><b>Ikhtisas : '. number_format($rsIkhtisas->fields['nilai'],0)." Permohonan (".number_format($pct1,2)."%)</b></label><br>"; 
  print '<label style="color:#00c0ef"><b>Bukan Ikhtisas : '.number_format($rsBukanIkhtisas->fields['nilai'],0)." Permohonan (".number_format($pct2,2)."%)</b></label><br>"; 
 ?>