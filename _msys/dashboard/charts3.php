...
<div class="card card-danger">
  <div class="card-header" align="center">
    <h4 class="card-title">Statistik Permohonan Ikhtisas</h4>
  </div>
  <div class="card-body">
    <canvas id="pieChart_ikhtisas" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 250px;"></canvas>
  </div>
  <!-- /.card-body -->
</div>
...
// print $start_dt;
$sql = "SELECT COUNT(*) as nilai FROM $schema2.calon_jawatan_dipohon A, $schema2.calon B  WHERE A.id_pemohon=B.id_pemohon AND B.pengakuan='Y' AND A.kod_peringkat IN('6')";
...
$sql2 = "SELECT COUNT(*) as nilai FROM $schema2.calon_jawatan_dipohon A, $schema2.calon B  WHERE A.id_pemohon=B.id_pemohon AND B.pengakuan='Y' AND A.kod_peringkat IN('4')";
...
name: 'Jumlah',
data: [";
$datasIBI.= "['DG29 ( ".$rsIkhtisas->fields['nilai']." )',".$rsIkhtisas->fields['nilai']."],";
$datasIBI.= "['DG41 ( ".$rsBukanIkhtisas->fields['nilai']." )',".$rsBukanIkhtisas->fields['nilai']."]";
...
<script type="text/javascript">
  $(function () {
    ...
    var pieChartCanvas = $('#pieChart_ikhtisas').get(0).getContext('2d')
...
<b>Nota: Jumlah Permohonan</b><br>
  ...
  print '<label style="color:#f39c12"><b>DG29 : '. number_format($rsIkhtisas->fields['nilai'],0)."  (".number_format($pct1,2)."%)</b></label><br>"; 
  print '<label style="color:#00c0ef"><b>DG41 : '.number_format($rsBukanIkhtisas->fields['nilai'],0)."  (".number_format($pct2,2)."%)</b></label><br>"; 
 ?>