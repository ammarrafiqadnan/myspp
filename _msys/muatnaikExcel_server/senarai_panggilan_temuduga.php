                    ...
                    <tbody>
                        ...
                        <?php 
                            ...
                            while(!$rs->EOF){ $bil2=0; 
                                ...
                                $id = $rs->fields['kod'];
                                $rsJ = $conn->query("SELECT COUNT(*) as total FROM $schema2.`senarai_panggilan_temuduga` WHERE kod_panggilan_temuduga=".tosql($id));
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="index.php?data=<?php print base64_encode('muatnaikExcel/senarai_pemohon_panggilan_temuduga;PENGURUSAN;Senarai Panggilan Temu Duga;;;'.$id.';'); ?>" class="btn btn-sm btn-success" title="Senarai Pemohon Panggilan Temuduga">
