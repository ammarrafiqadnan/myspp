...
?>
		...
		<?php if($_SESSION['SESSADM_UROLE'] != 3){ ?>
            <div class="col-md-12" style="height: 40px;background-color:#F2F2F2;">
                <div class="row">
			...
			<th width="15%"><font color="#000000"><div align="center">Detail</div></font></th>
                    ...
                    <?php 
                        ...
                        while(!$rs->EOF){ $bil2=0; 
                            ...
                            $id = $rs->fields['kod'];
                            // $conn->debug=true;
                            $rsJ = $conn->query("SELECT COUNT(*) as total FROM $schema2.`senarai_keputusan_temuduga` WHERE kod_keputusan_temuduga=".tosql($id). " AND is_deleted=0");
