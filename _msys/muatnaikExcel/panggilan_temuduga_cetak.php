...
$kod=strtoupper(isset($_REQUEST["kod"])?$_REQUEST["kod"]:"");
?>


        <div class="box" style="background-color:#F2F2F2">
            <b>Senarai Panggilan Temuduga</b>

            <?php
                //$conn->debug=true;
                $sql = "SELECT * FROM $schema2.`senarai_panggilan_temuduga` WHERE kod IS NOT NULL AND is_deleted=0 AND kod_panggilan_temuduga='{$kod}'"; 
                if(!empty($carian)){
            ...
            <div class="box-body" style="background-color:#F2F2F2">
                <table width="100%" cellpadding="5" cellspacing="0" border="1">
                    <thead  style="background-color:rgb(209 29 29)">
                        <!--<th width="10%"><font color="#000000"><div align="center">No.</div></font></th>-->
