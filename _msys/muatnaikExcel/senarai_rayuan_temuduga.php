...
$hrefs = 'index.php?data='.base64_encode('muatnaikExcel/senarai_rayuan_temuduga;Pengurusan;Senarai Rayuan Temu Duga;;;;');
?>
...
<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
		...
		<div class="box" style="background-color:#F2F2F2">
            ...
            <div class="box-body" style="height: 40px;background-color:#F2F2F2;">
                <div class="row">
                    <div class="col-md-12" align="right">
                        <a href="muatnaikExcel/form_rayuan_temuduga.php?kod=" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Rayuan Temuduga">
                            <i class="fa fa-plus"></i> Tambah Rayuan Temuduga
                        </a>
                    </div>
                </div>   
            </div>
            ...
            <?php
                // $conn->debug=true;
                $sql = "SELECT A.* FROM $schema2.`rayuan_temuduga` A WHERE A.is_deleted=0";
                if(!empty($tahun_list)){
                ...
                $sSQL1 = "SELECT COUNT(*) as total FROM $schema2.`rayuan_temuduga` WHERE is_deleted=0";
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <?php 
                        ...
                        while(!$rs->EOF){ $bil2=0; 
                            ...
                            $id = $rs->fields['kod'];
                            $rsJ = $conn->query("SELECT COUNT(*) as total FROM $schema2.`senarai_rayuan_temuduga` WHERE kod_rayuan_temuduga=".tosql($id));
                    ...
                    ?>
                        <tr>
                            ...
                            <td align="center">
                                <a href="muatnaikExcel/form_rayuan_temuduga.php?kod=<?=$rs->fields['kod'];?>" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Rayuan Temuduga">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="index.php?data=<?php print base64_encode('muatnaikExcel/senarai_pemohon_rayuan_temuduga;PENGURUSAN;Senarai Rayuan Temu Duga;;;'.$id.';'); ?>" class="btn btn-sm btn-success" title="Senarai Rayuan Temuduga">
                                <!-- <a href="index.php?data=<?php print base64_encode('senarai_rayuan_temuduga;PENGURUSAN;Senarai rayuan Temu Duga;;;;'); ?>"> -->
                                    <i class="fa fa-list"></i>
                                </a>
                                <button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('muatnaikExcel/sql_muatnaikExcel.php?frm=RAYUAN_TEMUDUGA&pro=HAPUS&kod=<?=$rs->fields['kod'];?>')">
