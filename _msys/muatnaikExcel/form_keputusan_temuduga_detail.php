...
<script>
	function do_save(){
		...
		swal({
			title: 'Adakah anda pasti untuk muat naik data bagi urusan keputusan temuduga?',
			...
			$.ajax({
				url:'muatnaikExcel/sql_muatnaikExcel.php?frm=KEPUTUSAN_TEMUDUGA&pro=UPLOAD',
				type:'POST',
				//dataType: 'json',
				beforeSend: function () {
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
								...
								<small style="color: red;">Hanya format csv, xls dan xlsx sahaja diterima.</small>
                            </div>
                        </div>
                    </div>
