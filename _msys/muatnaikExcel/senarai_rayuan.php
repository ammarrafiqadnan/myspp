...
?>
		...
		<div class="box" style="background-color:#F2F2F2">
			...
			<!-- <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
                ...
                <h6 class="panel-title"><font color="#000000"><b>Maklumat Senarai Pemohon Rayuan</b></font></h6> 
            </header> -->
			</div>
            </div>            
            <br />
            ...
            <div class="box-body" style="height: 40px;background-color:#F2F2F2;">
                <div class="row">
                    ...
                    <div class="col-md-12" align="right">
                        <button class="btn btn-md btn-primary" title="Muatnaik excel senarai pemohon rayuan">
                           <i class="fa fa-upload"></i> Muatnaik excel senarai pemohon rayuan
                        </button>
                    </div>
                </div>   
            </div>
			...
			<div class="box-body" style="background-color:#F2F2F2">
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead  style="background-color:rgb(38, 167, 228)">
                        ...
                        <th width="20%"><font color="#000000"><div align="center">Nama Penuh</div></font></th>
                        ...
                        <th width="20%"><font color="#000000"><div align="center">Sebab Rayuan</div></font></th>
                        <th width="15%"><font color="#000000"><div align="center">Kelayakan <br><small style="color: #fff;">Nota: Tanda '/' jika pemohon layak mohon rayuan</small></div></font></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>10/11/2022</td>
                            <td>xxx-xxxxxxxx</td>
                            <td align="center"><button class="btn-success badge">Terima</button></td>
                            <td>-</td>
                            <td align="center">
                        ...
                        <tr>
                            ...
                            <td>10/11/2022</td>
                            <td>xxx-xxxxxxxx</td>
                            <td align="center"><button class="btn-danger badge">Tidak Terima</button></td>
                            <td>abcdefg</td>
                            <td align="center">
                                <input type="checkbox">
                            </td>
