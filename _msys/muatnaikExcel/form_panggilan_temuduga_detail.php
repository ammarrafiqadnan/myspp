...
<script>
	function do_save(){
		...
		swal({
			title: 'Adakah anda pasti untuk muat naik data bagi urusan panggilan temuduga?',
			...
			$.ajax({
				url:'muatnaikExcel/sql_muatnaik_temuduga.php?frm=PANGGILAN_TEMUDUGA&pro=UPLOAD',
				type:'POST',
				//dataType: 'json',
				beforeSend: function () {
			...
			swal({
				title: 'Amaran',
				text: 'Terdapat ralat sistem.\nHanya file berformat .csv sahaja dibenarkan.',
				type: 'error',
				confirmButtonClass: "btn-warning",
				confirmButtonText: "Ok",
				showConfirmButton: true,
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
								...
								<large style="color: red;">Hanya format csv sahaja diterima.</large>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
							<div id="loading" align="center">
								<img src="../images/load3.gif" width="160px">
								<br><br>
								<b>Sila tunggu sehingga proses selesai</b>
							</div>
						</div>
					</div>
