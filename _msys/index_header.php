...
// if(!$rsDT->EOF){ $_SESSION['SESSADM_UPDATE']='UPDATE'; }
// else { $_SESSION['SESSADM_UPDATE']=''; }
//$conn->debug=false;

//print $_SESSION['SESSADM_UPDATE']; exit;
...
<script language="javascript">
	...
	<body style="background-image:url(../images/bgspp.png)">
		...
		<section class="body">
			<!-- start: header -->
			<header class="header" style="background-image:url(../images/bgspp.png)">
				<div class="logo-container d-print-none">
                    ...
                    <div id="userbox" class="userbox1 visible-xs"> 
                    	<figure class="profile-picture">
								<img src="../images/person.jpg" alt="<?=$_SESSION['SESSADM_UNAME'];?>" class="img-circle" data-lock-picture="../images/person.jpg" />
						</figure>
                        <a href="#" data-toggle="dropdown"></a>
						<div class="dropdown-menu" style="margin-left:-50px;width:250px">
							<div style="padding-left:10px"><br>
							<span class="name"><b><?=$_SESSION['SESSADM_UNAME'];?></b></span>
							<!--<span class="role"><?//=$_SESSION['SESSADM_UJAWATAN'];?>:<?//=$_SESSION['SESSADM_ULEVEL'];?></span>-->
							</div>
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="pengurusan/pengguna_form.php?id=<?=$_SESSION['SESSADM_UID'];?>&jenis=pengguna" 
										data-toggle="modal" data-target="#myModal"><i class="fa fa-user"></i> Profile Saya</a>
								</li>
								<li>
									<a role="menuitem" tabindex="-1" href="userpwd_form.php?id=<?=$_SESSION['SESSADM_UID'];?>" 
...
// 	$sqlagensi = " "; //AND A.agensi_id=".tosql($_SESSION['SESSADM_AGENSIID']);
// } else {
// 	$sqlagensi=" ";
// }	
