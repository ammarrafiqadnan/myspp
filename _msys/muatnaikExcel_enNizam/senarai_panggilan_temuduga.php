		...
		<div class="box" style="background-color:#F2F2F2">
            ...
            <div class="box-body" style="height: 40px;background-color:#F2F2F2;">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <select name="tahun_list" id="tahun_list" class="form-control" onchange="do_page('<?=$ctual_link;?>')">
                    ...
                    <div class="col-md-2">
                        <select name="bulan_list" id="bulan_list" class="form-control" onchange="do_page('<?=$ctual_link;?>')">
                            <option value="01"<?php if($bulan_list=='01'){ print 'selected'; }?>>Januari</option>
                            <option value="02"<?php if($bulan_list=='02'){ print 'selected'; }?>>Februari</option>
                            <option value="03"<?php if($bulan_list=='03'){ print 'selected'; }?>>Mac</option>
                            <option value="04"<?php if($bulan_list=='04'){ print 'selected'; }?>>April</option>
                            <option value="05"<?php if($bulan_list=='05'){ print 'selected'; }?>>Mei</option>
                            <option value="06"<?php if($bulan_list=='06'){ print 'selected'; }?>>Jun</option>
                            <option value="07"<?php if($bulan_list=='07'){ print 'selected'; }?>>Julai</option>
                            <option value="08"<?php if($bulan_list=='08'){ print 'selected'; }?>>Ogos</option>
                            <option value="09"<?php if($bulan_list=='09'){ print 'selected'; }?>>September</option>
            ...
            <?php
                // $conn->debug=true;
                $sql = "SELECT * FROM $schema2.`panggilan_temuduga` WHERE is_deleted=0"; 
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <?php 
                        ...
                        while(!$rs->EOF){ $bil2=0; 
                            ...
                            $id = $rs->fields['kod'];
                            $rsJ = $conn->query("SELECT COUNT(*) as total FROM $schema2.`senarai_panggilan_temuduga` WHERE kod=".tosql($id));
                    ...
                    ?>
                        <tr>
                            ...
                            <td align="center">
                                <a href="muatnaikExcel/form_panggilan_temuduga.php?kod=<?=$rs->fields['kod'];?>" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Panggilan Temuduga">
                                ...
                                <button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('muatnaikExcel/sql_muatnaikExcel.php?frm=SIMPAN&jenis=PANGGILAN_TEMUDUGA&pro=HAPUS&kod=<?=$rs->fields['kod'];?>')">
