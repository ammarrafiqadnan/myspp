...
<div class="box" style="background-color:#F2F2F2">
    ...
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Senarai Maklumat Kursus SVM</b></font></h6> 
    </header>
    </div>
    </div>            
    <br /> 
    ...
    <div class="col-md-12" align="right">
        <a href="pengurusan/parameter/form_kursus_svm.php?kursus_svm_kod=" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Kursus SVM">
            <i class="fa fa-plus"></i> Tambah Kursus SVM
        </a>
    </div>
    <br>
    <?php
        ...
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="pengurusan/parameter/form_kursus_svm.php?kursus_svm_kod=<?=$rs->fields['KOD'];?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal" title="Kemaskini Maklumat Kursus SVM">
                            <i class="fa fa-edit"></i>
                        </a>
                        <button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('pengurusan/sql_pengurusan.php?frm=PARAMETER&jenis=KURSUS_SVM&pro=HAPUS&kursus_svm_kod=<?=$rs->fields['KOD'];?>')">
							<span style="cursor:pointer;color:red" title="Hapus maklumat kursus SVM"><i class="fa fa-trash-o" style="color: #FFFFFF;"></i></span>
						</button>
                    </td>
                </tr>
            <?php 
