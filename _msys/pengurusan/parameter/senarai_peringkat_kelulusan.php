...
$hrefs = 'index.php?data='.base64_encode('pengurusan/parameter/senarai_peringkat_kelulusan;Pentadbiran;Parameter;Peringkat Kelulusan;;;');
...
<div class="box" style="background-color:#F2F2F2">
    ...
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Senarai Maklumat Peringkat</b></font></h6> 
    </header>
    </div>
    </div>            
    <br /> 
    ...
    <div class="col-md-12" align="right">
        <a href="pengurusan/parameter/form_peringkat_kelulusan.php?peringkat_kelulusan_kod=" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Notifikasi">
            <i class="fa fa-plus"></i> Tambah Peringkat Kelulusan
        </a>
    </div>
    <br>
    <?php
        ...
        $sSQL1 = "SELECT COUNT(*) as total FROM $schema1.`ref_peringkat_kelulusan` WHERE is_deleted=0";
        if($status2 != ''){
    ...
    <div class="box-body" style="background-color:#F2F2F2">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead  style="background-color:rgb(38, 167, 228)">
                ...
                <th width="40%"><font color="#000000"><div align="center">Peringkat Kelulusan</div></font></th>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="pengurusan/parameter/form_peringkat_kelulusan.php?peringkat_kelulusan_kod=<?=$rs->fields['kod'];?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal" title="Kemaskini Maklumat Peringkat Kelulusan">
                            <i class="fa fa-edit"></i>
                        </a>
                        <button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('pengurusan/sql_pengurusan.php?frm=PARAMETER&jenis=PERINGKAT_KELULUSAN&pro=HAPUS&kod=<?=$rs->fields['kod'];?>')">
							<span style="cursor:pointer;color:red" title="Hapus maklumat peringkat kelulusan"><i class="fa fa-trash-o" style="color: #FFFFFF;"></i></span>
						</button>
                    </td>
                </tr>
            <?php 
