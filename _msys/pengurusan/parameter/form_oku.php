...
<script>
	function do_save(){
		...
		if(oku.trim() == '' ){
			alert_msg('Sila isi maklumat jenis OKU.');
			$('#oku').focus(); return true;
		} else if(status_oku.trim() == '' ){
			alert_msg('Sila pilih maklumat status OKU.');
...
<div class="col-lg-12">
	<section class="panel">
		<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
			...
			<h6 class="panel-title"><font color="#000000" size="3"><b><?php if(!empty($oku_kod)){ print 'KEMASKINI'; } else { print 'TAMBAH'; } ?> MAKLUMAT OKU</b></font></h6>
		</header>
