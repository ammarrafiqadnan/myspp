...
<script>
	function do_save(){
		...
		var kod_t = $('#kod_t').val();
		var major_t = $('#major_t').val();
		var kod = $('#kod').val();
		
		if((major_t == '' || kod_t =='') && kod ==''){
			alert_msg('Sila isi maklumat major.');
			$('#kod_t').focus(); return true;
		} 
	...
	function countlen(){
		const kod_t = document.getElementById('kod_t');
            if (kod_t.value.length != 4) {
...
<div class="col-lg-12">
	<section class="panel">
		...
		<div class="panel-body">
			...
			<?php if(empty($major_kod)) { ?>

				<div class="col-md-12">
					<div class="form-group">
						<div class="row">
							<label for="major" class="col-sm-3 control-label"><b>Kod<font color="#FF0000">*</font> : </b></label>
							<div class="col-sm-9">
								<input type="text" maxlength="4" name="kod_t" id="kod_t" class="form-control" style="text-transform:uppercase" value="" onmouseleave="countlen()">
							</div>
						</div>
					</div>
                    ...
                    <div class="form-group">
						<div class="row">
							...
							<div class="col-sm-9">
								<input type="text" name="major_t" id="major_t" class="form-control" style="text-transform:uppercase" value="">
							</div>
						</div>
					</div>
				...
				<div class="col-md-12">
					<div class="form-group">
						<div class="row">
							<label for="major" class="col-sm-3 control-label"><b>Kod<font color="#FF0000">*</font> : </b></label>
							<div class="col-sm-9">
								<input type="text" name="kod" id="kod" class="form-control" style="text-transform:uppercase" readonly value="<?php if(!empty($major_kod)){ print $rs->fields['KOD']; } ?>">
							</div>
						</div>
					</div>
                    ...
                    <div class="form-group">
						<div class="row">
							<label for="major" class="col-sm-3 control-label"><b>Diskripsi<font color="#FF0000">*</font> : </b></label>
							<div class="col-sm-9">
								<input type="text" name="major_t" id="major_t" class="form-control" style="text-transform:uppercase" readonly value="<?php if(!empty($major_kod)){ print $rs->fields['DISKRIPSI']; } ?>">
							</div>
						</div>
					</div>
