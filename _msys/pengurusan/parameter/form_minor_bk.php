...
<div class="col-lg-12">
	<section class="panel">
		...
		<div class="panel-body">
			...
			<input type="hidden" name="kod" id="kod" value="<?php if(!empty($minor_kod)){ print $rs->fields['KOD']; }?>"/>
				...
				<div class="col-md-12">
                    <div class="form-group">
						<div class="row">
							...
							<div class="col-sm-9">
								<input type="text" name="minor" id="minor" class="form-control" style="text-transform:uppercase" value="<?php if(!empty($minor_kod)){ print $rs->fields['DISKRIPSI']; } ?>">
							</div>
						</div>
					</div>
