...
$hrefs = 'index.php?data='.base64_encode('pengurusan/parameter/senarai_major;Pentadbiran;Parameter;Major;;;');
...
<div class="box" style="background-color:#F2F2F2">
    ...
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Senarai Maklumat Major</b></font></h6> 
    </header>
    </div>
    </div>            
    <br /> 
    ...
    <div class="col-md-12" align="right">
        <a href="pengurusan/parameter/form_major.php?major_kod=" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Notifikasi">
            <i class="fa fa-plus"></i> Tambah Major
        </a>
    </div>
    <br>
    <?php
        //$conn->debug=true;
        $sql = "SELECT * FROM $schema1.`ref_major` WHERE is_deleted=0"; 
        if($status2 != ''){
        ...
        $sSQL1 = "SELECT COUNT(*) as total FROM $schema1.`ref_major` WHERE is_deleted=0";
        if($status2 != ''){
    ...
    <div class="box-body" style="background-color:#F2F2F2">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead  style="background-color:rgb(38, 167, 228)">
                ...
                <th width="40%"><font color="#000000"><div align="center">Major</div></font></th>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="pengurusan/parameter/form_major.php?major_kod=<?=$rs->fields['KOD'];?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal" title="Kemaskini Maklumat Major">
                            <i class="fa fa-edit"></i>
                        </a>
                        <button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('pengurusan/sql_pengurusan.php?frm=PARAMETER&jenis=MAJOR&pro=HAPUS&kod=<?=$rs->fields['KOD'];?>')">
							<span style="cursor:pointer;color:red" title="Hapus maklumat major"><i class="fa fa-trash-o" style="color: #FFFFFF;"></i></span>
						</button>
                    </td>
                </tr>
            <?php 
