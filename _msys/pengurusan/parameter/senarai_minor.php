...
$hrefs = 'index.php?data='.base64_encode('pengurusan/parameter/senarai_minor;Pentadbiran;Parameter;Minor;;;');
...
<div class="box" style="background-color:#F2F2F2">
    ...
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Senarai Maklumat Minor</b></font></h6> 
    </header>
    </div>
    </div>            
    <br /> 
    ...
    <div class="col-md-12" align="right">
        <a href="pengurusan/parameter/form_minor.php?minor_kod=" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Notifikasi">
            <i class="fa fa-plus"></i> Tambah Minor
        </a>
    </div>
    <br>
    <?php
        //$conn->debug=true;
        $sql = "SELECT * FROM $schema1.`ref_minor` WHERE is_deleted=0"; 
        if($status2 != ''){
        ...
        $sSQL1 = "SELECT COUNT(*) as total FROM $schema1.`ref_minor` WHERE is_deleted=0";
        if($status2 != ''){
    ...
    <div class="box-body" style="background-color:#F2F2F2">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead  style="background-color:rgb(38, 167, 228)">
                ...
                <th width="40%"><font color="#000000"><div align="center">Minor</div></font></th>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="pengurusan/parameter/form_minor.php?minor_kod=<?=$rs->fields['KOD'];?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal" title="Kemaskini Maklumat Minor">
                            <i class="fa fa-edit"></i>
                        </a>
                        <button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('pengurusan/sql_pengurusan.php?frm=PARAMETER&jenis=MINOR&pro=HAPUS&kod=<?=$rs->fields['KOD'];?>')">
							<span style="cursor:pointer;color:red" title="Hapus maklumat minor"><i class="fa fa-trash-o" style="color: #FFFFFF;"></i></span>
						</button>
                    </td>
                </tr>
            <?php 
