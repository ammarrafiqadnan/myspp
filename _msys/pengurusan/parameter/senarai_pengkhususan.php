...
$hrefs = 'index.php?data='.base64_encode('pengurusan/parameter/senarai_pengkhususan;Pentadbiran;Parameter;Pengkhususan;;;');
...
<div class="box" style="background-color:#F2F2F2">
    ...
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Senarai Maklumat Pengkhususan</b></font></h6> 
    </header>
    </div>
    </div>            
    <br /> 
    <div class="col-md-12" style="background-color:#F2F2F2;">
        ...
        <label for="nama" class="col-sm-1 control-label">Status:</label>
            ...
            <div class="col-md-2" style="background-color:#F2F2F2">
                <!-- <a href="pengurusan/parameter/form_pengkhususan.php?pengkhususan_kod=" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Pengkhususan">
    ...
    <?php
        //$conn->debug=true;
        $sql = "SELECT * FROM $schema1.`ref_pengkhususan` WHERE is_deleted=0"; 
        if($status2 != ''){
        ...
        $sSQL1 = "SELECT COUNT(*) as total FROM $schema1.`ref_pengkhususan` WHERE is_deleted=0";
        if($status2 != ''){
    ...
    <div class="box-body" style="background-color:#F2F2F2">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead  style="background-color:rgb(38, 167, 228)">
                ...
                <th width="35%"><font color="#000000"><div align="center">Pengkhususan</div></font></th>
                <th width="22%"><font color="#000000"><div align="center">Nama Institusi</div></font></th>
                <th width="15%"><font color="#000000"><div align="center">No. Pemerolehan</div></font></th>
            ...
            <?php 
                ...
                while(!$rs->EOF){ $bil2=0; 
                    ...
                    $rss = $conn->query("SELECT B.`DISKRIPSI` FROM $schema1.`padanan_institusi_pengkhususan` A, $schema1.`ref_institusi` B WHERE A.`kod_institusi`=B.`KOD` AND A.`kod_pengkhususan`=".tosql($rs->fields['kod']));
                    $nama_institusi = $rss->fields['DISKRIPSI'];
                ?>
                <tr>
                    <td align="center"><?=++$bil;?></td>
                    <td align="center"><?=$rs->fields['kod'];?></td>
                    <td><?php print $rs->fields['DISKRIPSI'];?></td>
                    <td align="center"><?php print $nama_institusi;?></td>
                    <td align="center"><?php print $rs->fields['NO_PEMEROLEHAN'];?></td>
                    <td align="center">
                        <?php 
                    ...
                    <td align="center">
                        <a href="pengurusan/parameter/form_pengkhususan.php?pengkhususan_kod=<?=$rs->fields['kod'];?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal" title="Kemaskini Maklumat Pengkhususan">
                            <i class="fa fa-edit"></i>
                        </a>
                        <button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('pengurusan/sql_pengurusan.php?frm=PARAMETER&jenis=PENGKHUSUSAN&pro=HAPUS&kod=<?=$rs->fields['kod'];?>')">
							<span style="cursor:pointer;color:red" title="Hapus maklumat pengkhususan"><i class="fa fa-trash-o" style="color: #FFFFFF;"></i></span>
						</button>
                    </td>
                </tr>
            <?php 
