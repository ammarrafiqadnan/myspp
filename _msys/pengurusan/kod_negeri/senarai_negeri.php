...
$hrefs = 'index.php?data='.base64_encode('pengurusan/kod_negeri/senarai_negeri;Pentadbiran;Parameter;ALL;;;');
...
<div class="box" style="background-color:#F2F2F2">
    ...
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Senarai Maklumat Negeri</b></font></h6> 
    </header>
    </div>
    </div>            
    <br /> 
    <div class="col-md-12" style="background-color:#F2F2F2;">
        ...
        <label for="nama" class="col-sm-1 control-label">Status:</label>
            ...
            <div class="col-md-5" style="background-color:#F2F2F2">
                <input type="text" id="carian"  name="carian" value="<?=$carian;?>" class="form-control" placeholder="Kod/Negeri">
            </div>
    ...
    <br>
    <?php
        $sql3 = "SELECT * FROM $schema2.`ref_negeri` WHERE kod IS NOT NULL";
        if($status2 != ''){
            $sql3 .= " AND `status`=".$status2;
        }

        if(!empty($carian)){
            $sql3 .= " AND ((kod LIKE '%".$carian."%') OR (diskripsi2 LIKE '%".$carian."%'))";
        }
    ...
    <div class="box-body" style="background-color:#F2F2F2">
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead  style="background-color:rgb(38, 167, 228)">
                ...
                <th width="30%"><font color="#000000"><div align="center">Negeri</div></font></th>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td><?php print $rsState->fields['diskripsi2'];?></td>
                    <td align="center">
                        <?php 
                    ...
                    <td align="center">
                        <a href="pengurusan/kod_negeri/form_negeri.php?negeri_kod=<?=$rsState->fields['kod'];?>" class="btn btn-md btn-success" data-toggle="modal" data-target="#myModal" title="Kemaskini Maklumat Negeri">
