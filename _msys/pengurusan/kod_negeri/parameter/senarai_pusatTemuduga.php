...
<div class="box" style="background-color:#F2F2F2">
    ...
    <div class="col-md-12" align="right">
        <a href="pengurusan/parameter/form_pusatTemuduga.php?pusatTemuduga_kod=" class="btn btn-md btn-primary" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat Notifikasi">
    ...
    <?php
        //$conn->debug=true;
        $sql = "SELECT * FROM $schema1.`ref_pusat_temuduga` WHERE is_deleted=0"; 
        ...
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="pengurusan/parameter/form_pusatTemuduga.php?pusatTemuduga_kod=<?=$rs->fields['kod'];?>" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal" title="Kemaskini Maklumat Bangsa">
                            <i class="fa fa-edit"></i>
                        </a>
                        <button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('pengurusan/sql_pengurusan.php?frm=PARAMETER&jenis=PUSAT_TEMUDUGA&pro=HAPUS&kod=<?=$rs->fields['kod'];?>')">
							<span style="cursor:pointer;color:red" title="Hapus maklumat pusatTemuduga"><i class="fa fa-trash-o" style="color: #FFFFFF;"></i></span>
						</button>
                    </td>
                </tr>
            <?php 
