				...
				<div class="col-md-12">
                    ...
                    <div class="form-group">
						<div class="row">
							...
							<div class="col-sm-10">
								<input type="text" name="pengkhususan" id="pengkhususan" class="form-control" value="<?php if(!empty($pengkhususan_kod)){ print $rs->fields['DISKRIPSI']; } ?>" onchange="do_pengkhususan(this.value)">
							</div>
						</div>
					</div>
