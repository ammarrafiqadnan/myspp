			...
			<!--
                    ...
                    -->
                        ...
                        <tr>
                            ...
                            <td>Major</td>
                            <td align="center">
                                <a href="index.php?data=<?php print base64_encode('pengurusan/parameter/senarai_major;Pentadbiran;Parameter;Major;;;'); ?>" class="btn btn-md btn-success" data-toggle="modal" data-taraget="#myModal" title="Kemaskini Maklumat Major">
                                    <i class="fa fa-edit"></i>
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>Minor</td>
                            <td align="center">
                                <a href="index.php?data=<?php print base64_encode('pengurusan/parameter/senarai_minor;Pentadbiran;Parameter;Minor;;;'); ?>" class="btn btn-md btn-success" data-toggle="modal" data-taraget="#myModal" title="Kemaskini Maklumat Minor">
                                    <i class="fa fa-edit"></i>
                                </a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>Kursus SVM</td>
                            <td align="center">
                                <a href="index.php?data=<?php print base64_encode('pengurusan/parameter/senarai_kursus_svm;Pentadbiran;Parameter;Kursus SVM;;;'); ?>" class="btn btn-md btn-success" data-toggle="modal" data-taraget="#myModal" title="Kemaskini Maklumat Kursus SVM">
                                    <i class="fa fa-edit"></i>
                                </a>
                            </td>
                        </tr>
