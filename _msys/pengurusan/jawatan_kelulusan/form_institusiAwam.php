		...
		<div id="modalPK" class="box" style="background-color:#F2F2F2">
            ...
            <div class="box-body" style="height: 40px;background-color:#F2F2F2;">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <!-- <button class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal" onclick="do_carianCK('pengurusan/jawatan_kelulusan/form_institusiAwam.php?peringkat2=<?=$peringkat2;?>&kategori=awam')">Carian</button> -->
