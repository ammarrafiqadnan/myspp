...
<div class="box" style="background-color:#F2F2F2">
    ...
    <div class="col-md-12 d-print-none" style="background-color:#F2F2F2;">
        <div class="row">
            ...
            <div class="col-md-2">
                <select name="zon" id="zon" class="form-control" onchange="get_negeri(this.value)">
                    <option value="">Sila pilih</option>
            ...
            <div class="col-md-7">
                ...
                <select name="negeri" id="negeri" class="select2bs4 form-control" multiple="multiple">
                    ...
                    <?php $rsState->movefirst();
                        while(!$rsState->EOF){ 
                            print '<option value="'.$rsState->fields['kod'].'"';
                            if(in_array($rsState->fields['kod'], $neg)){ print 'selected'; }
                            print '>'.$rsState->fields['diskripsi2'].'</option>';
