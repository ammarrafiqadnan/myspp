						...
						<div class="row">
							...
							<div class="col-sm-8">
								<select name="" id="" class="form-control">
									...
									<option>BEKAS POLIS</option>
									<option>BEKAS TENTERA LAUT</option>
								</select>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<select class="form-control">
									...
									<option>ASSISTANT COMMISIONER POLIS</option>
								</select>
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-3">
								<select class="form-control">
									<option>Sila pilih</option>
									<option>MENERIMA PENCEN</option>
									<option>MENERIMA GANJARAN</option>
								</select>
							</div>
						</div>
					</div>
