    ...
    <div class="panel-body">
        <div class="box-body">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-2 control-label">JENIS<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-10">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-2 control-label">SUMBAGAN<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-7">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-2 control-label">TAHUN<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-3">
                        <select name="" class="form-control">
                            <option>Sila pilih</option>
                        </select>
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-2 control-label">PERINGKAT<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-7">
                        <select name="" class="form-control">
                            <option>Sila pilih</option>
                        </select>
