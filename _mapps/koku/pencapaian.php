...
function do_pencapaian(){
  ...
  if(rekacipta.trim() == '' && sumbangan.trim() == '' && peringkat.trim() == ''){
      msg = msg+'\n- Sila masukkan maklumat rekacipta & inovasi.';
      ...
      msg = msg+'\n- Sila pilih maklumat sumbangan.';
      msg = msg+'\n- Sila pilih maklumat peringkat.';
      $("#rekacipta").css("border-color","#ccc");
      $("#sumbangan").css("border-color","#f00");
      $("#peringkat").css("border-color","#f00");
  } else if(rekacipta.trim() != '' && sumbangan.trim() != '' && peringkat.trim() == ''){
      msg = msg+'\n- Sila pilih maklumat peringkat.';
      ...
      <br>
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-8">
								<input type="text" name="rekacipta" id="rekacipta" value="<?php print $rsRekacipta->fields['rekacipta'];?>" class="form-control text-uppercase" onchange="do_btn()" maxlength="60">
								<input type="hidden" name="rekaciptaAsal" id="rekaciptaAsal" value="<?php if(!empty($rsRekacipta->fields['rekacipta'])){ print $rsRekacipta->fields['rekacipta']; } ?>" class="form-control">
								<input type="hidden" name="sumbanganAsal" id="sumbanganAsal" value="<?php if(!empty($rsRekacipta->fields['sumbangan'])){ print $rsRekacipta->fields['sumbangan']; } ?>" class="form-control">
								<input type="hidden" name="peringkatAsal" id="peringkatAsal" value="<?php if(!empty($rsRekacipta->fields['peringkat'])){ print $rsRekacipta->fields['peringkat']; } ?>" class="form-control">
							</div>
						</div>
					</div>
					<?php 
					...
					if(!empty($rsRekacipta->fields['sumbangan'])){ $sumbangan1 = $rsRekacipta->fields['sumbangan']; } else { $sumbangan1=''; }
					?>
					<div class="form-group">
						<div class="row">
							<label for="nama" class="col-sm-2 control-label"><b>Sumbangan <div style="float:right">:</div></b></label>
							<div class="col-sm-6">
								<select class="form-control" name="sumbangan" id="sumbangan" onchange="do_btn()">
									<option value="">Sila pilih</option>
									<?php while(!$rsPangkat->EOF){ ?>
									<option value="<?=$rsPangkat->fields['KOD'];?>" <?php if($rsPangkat->fields['KOD']==$sumbangan1){ print 'selected'; }?>><?=$rsPangkat->fields['DISKRIPSI'];?></option>
					...
					if(!empty($rsRekacipta->fields['peringkat'])){ $peringkat = $rsRekacipta->fields['peringkat']; } else { $peringkat=''; }
					?>
					<div class="form-group">
						<div class="row">
							<label for="nama" class="col-sm-2 control-label"><b>Peringkat <div style="float:right">:</div></b></label>
							<div class="col-sm-6">
								<select class="form-control" name="peringkat" id="peringkat" onchange="do_btn()">
									<option value="">Sila pilih</option>
									<?php while(!$rsPeringkat->EOF){ ?>
									<option value="<?=$rsPeringkat->fields['KOD'];?>" <?php if($rsPeringkat->fields['KOD']==$peringkat){ print 'selected'; }?>><?=$rsPeringkat->fields['DISKRIPSI'];?></option>
            ...
            <div class="box-body" style="background-color:#F2F2F2">
              <div class="form-group">
						<div class="row">
							...
							<div class="col-sm-10">
								<input type="text" maxlength="60" name="pencapaian" id="pencapaian" class="form-control text-uppercase" 
									value="<?php if(!empty($rsPencapaian->fields['pencapaian'])){ print $rsPencapaian->fields['pencapaian']; } ?>" onchange="do_btn()">
								<input type="hidden" name="pencapaianAsal" id="pencapaianAsal" class="form-control" 
									value="<?php if(!empty($rsPencapaian->fields['pencapaian'])){ print $rsPencapaian->fields['pencapaian']; } ?>">
							</div>
						</div>
					</div>
            </div>
