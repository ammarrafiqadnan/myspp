    ...
    <div class="panel-body">
        <div class="box-body">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-2 control-label">NAMA PERSATUAN<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-10">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-2 control-label">JAWATAN<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-7">
