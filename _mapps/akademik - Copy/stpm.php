...
<!-- 				                    <?php if(!empty($data['stp_tahun_2'])){ ?>
					                ...
					                <div style="float: right;">
					                	<a href="akademik/stpm_add.php?id_pemohon=<?=$uid;?>&tahun=<?=$data['stp_tahun_1'];?>" data-toggle="modal" data-target="#myModal" title="Tambah Maklumat" class="fa" data-backdrop=""><button type="button" class="btn btn-primary">
				                ...
				                <div class="tab-content tabs">
				                    <!-- <div role="tabpanel" class="tab-pane fade in active"> -->
				                        <?php include 'akademik/stpm1.php';?>
				                    <!-- </div> -->
			        	...
			        	<div class="col-md-12">
				            <div class="tab" role="tabpanel">
				                ...
				                <ul class="nav nav-tabs" role="tablist">
				                    ...
				                    <?php if(!empty($data['stp_tahun_1'])){ ?>
					                <div style="float: right;">
					                	<label class="btn btn-danger" onclick="do_hapus('akademik/sql_akademik.php?frm=STPM&pro=STPM2_DEL&id_pemohon=<?=$uid;?>')">Hapus Maklumat</label>
					                </div>
					            	<?php } ?>
<!-- 				                    <?php if(!empty($data['stp_tahun_2'])){ ?>
				                    <li role="presentation"><a href="index.php?data=YWthZGVtaWsvc3BtO01BS0xVTUFUIEFLQURFTUlLO01ha2x1bWF0IFNQTS9NQ0UvU1BWTS9TUE0oVik7Ozs7" aria-controls="profile" role="tab" data-toggle="tab">
				                ...
				                <div class="tab-content tabs">
				                    <!-- <div role="tabpanel2" class="tab-pane fade"> -->
				                        <?php include 'akademik/stpm2.php';?>
				                    <!-- </div> -->
