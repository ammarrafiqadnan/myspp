			...
			<input type="hidden" name="id_pemohon" id="id_pemohon" value="<?php print $uid;?>" readonly="readonly"/>
				...
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<?php 
					    $hrefs1 = "index.php?data=".base64_encode('akademik/spm;MAKLUMAT AKADEMIK;Maklumat SPM/MCE/SPVM/SPM(V);;1;;');  
					    $hrefs2 = "index.php?data=".base64_encode('akademik/spm;MAKLUMAT AKADEMIK;Maklumat SPM/MCE/SPVM/SPM(V);;2;;');  
