	...
	<div class="form-group">
		<div class="row">
			<div class="col-sm-8">
				<div class="row">
					...
					<div class="col-sm-4 col-xm-4" style="padding-bottom:5px">
						...
						<select class="form-control" name="gred_2[]">
							...
							<?php 
							$result = get_spm_result($conn, $uid, "103", $tahun, "T");
							$rsGred->movefirst();
							while(!$rsGred->EOF){ ?>
				...
				$rsResult = $conn->query("SELECT * FROM $schema2.`calon_spm` WHERE `jenis_xm`='T' AND `id_pemohon`=".tosql($uid). " AND tahun=".tosql($tahun2). " AND matapelajaran NOT IN ('002')");
