...
$sql = "SELECT * FROM $schema2.myid WHERE ICNo=".tosql($id);
    ...
    <div class="panel-body">
        ...
        <div class="col-md-12">            
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" name="ICNo" id="ICNo" class="form-control" placeholder="No Kad Pengenalan" 
                    value="<?php print $rsData->fields['ICNo'];?>" maxlength="12" readonly="readonly"> 
                </div>
				</div>
            </div>
			...
			<div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="email" name="emel" id="emel" class="form-control" readonly="readonly" 
