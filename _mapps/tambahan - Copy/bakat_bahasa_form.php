...
<section class="panel">
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000" size="3"><b>MAKLUMAT KEBOLEHAN BAHASA / DIALEK SELAIN BAHASA MELAYU</b></font></h6>
    </header>
    <div class="panel-body">
        <div class="box-body">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-3 control-label">JENIS BAHASA/DIALEK<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-9">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-3 control-label">PENGUASAAN<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-6">
                        <select name="" class="form-control">
                            <option>Sila pilih</option>
                            <option>BERTUTUR</option>
                            <option>MENULIS</option>
                            <option>BERTUTUR & MENULIS</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <!-- <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-3 control-label">PERINGKAT<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-7">
                        <select name="" class="form-control">
                            <option>Sila pilih</option>
                        </select>
            ...
            <!-- <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-3 control-label">MUATNAIK SIJIL<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-9">
                        <input type="file" name="info_tarikh" id="info_tarikh" class="form-control" value="" />
                    </div>
                </div>
            </div> -->
