...
function do_save(val1, val2){
    ...
    if(addr1.trim() ==''){
        msg = msg+'- Sila masukkan alamat surat menyurat.';
                ...
                <hr>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-3">
								<select name="bandar" id="bandar" class="form-control select2 select2-accessible" style="width: 100%;" aria-hidden="true">
					...
					<div class="form-group">
						<div class="row"> 
							...
							<div class="col-sm-3">
								<select name="negeri_lahir_ibu" id="negeri_lahir_ibu" class="form-control select2 select2-accessible" style="width: 100%;" aria-hidden="true">									
									<option value="">Sila pilih Negeri</option>
							...
							<div class="col-sm-3">
								<select name="negeri_lahir_bapa" id="negeri_lahir_bapa" class="form-control select2 select2-accessible" style="width: 100%;" aria-hidden="true">									
									<option value="">Sila pilih Negeri</option>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-2">
								<input type="" name="ketinggian" id="ketinggian" value="<?=$data['ketinggian'];?>" class="form-control">
							</div>

							<div class="col-sm-2"></div>
							<label for="nama" class="col-sm-2 control-label"><b>Berat (KG) <font color="#FF0000">*</font><div style="float:right">:</div></b></label>
							<div class="col-sm-2">
								<input type="" name="berat" id="berat" value="<?=$data['berat'];?>" class="form-control">
							</div>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-2">
								<input type="radio" name="masih_khidmat" id="masih_khidmat" value="Y" <?php if($data['masih_khidmat']=='Y'){ print 'checked'; }?>> Ya &nbsp;
								<input type="radio" name="masih_khidmat" id="masih_khidmat" value="T" <?php if($data['masih_khidmat']=='T'){ print 'checked'; }?>> Tidak &nbsp;
							</div>
						</div>
