...
if(!empty($rsData->fields['spm_tahun_1']) || !empty($rsData->fields['spm_tahun_2'])){ 
	...
	if(!empty($rsData->fields['spm_jenis_sijil_1']) && $rsData->fields['spm_jenis_sijil_1']==6){
		//SVM
		//print "DDD".$rsData->fields['spm_jenis_sijil_1'];
	...
	if(!empty($rsData->fields['spm_jenis_sijil_2']) && $rsData->fields['spm_jenis_sijil_2']==6){
		//SVM
		//print "DDD".$rsData->fields['spm_jenis_sijil_2'];
...
//if($gcond=='4' || $gcond=='5' || $gcond=='6' || $gcond=='5,9' || $gcond=='5,9,7' || $gcond=='5,7,9' || $gcond=='5,9,10' || $gcond=='5,6,10' || $gcond=='4,10' || $gcond=='6,10' || $gcond=='10,4' || $gcond=='10,5' || $gcond=='10,6' || $gcond=='10,7' || $gcond=='10,8' || $gcond=='10,4,6' || $gcond=='10,7'){
	//$gcond=0;
//} else {
	if($gcond=='7'){ $gcond=''; }
	else if($gcond=='8'){ $gcond=''; }
	else if($gcond=='1,7'){ $gcond='1'; }
	else if($gcond=='1,8'){ $gcond='1'; }
	else if($gcond=='1,2,8'){ $gcond='1,2'; }
	//else if($gcond=='1,2,5'){ $gcond='1,3'; }
	//else if($gcond=='1,5'){ $gcond='1,3'; }
	else if($gcond=='1,5'){ $gcond='1'; }
	else if($gcond=='2,8'){ $gcond='2'; }
	else if($gcond=='1,3,8'){ $gcond='1,3'; }
	else if($gcond=='3,8'){ $gcond='3'; }
	else if($gcond=='2,9'){ $gcond='2'; }
	else if($gcond=='2,3,8'){ $gcond='2,3'; }
	else if($gcond=='2,3,9'){ $gcond='2,3'; }
		...
		<div class="panel-body">
			...
			<input type="hidden" name="id_pemohon" id="id_pemohon" value="<?php print $_SESSION['SESS_UID'];?>" readonly="readonly"/>
				...
				<div class="col-md-12">
					...
					if(!empty($sijilid)){ $sqlJ .= " AND A.`kod_skim` !='4735' "; }
