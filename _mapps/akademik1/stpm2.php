			...
			<div class="col-sm-8">
				<div class="row">
					...
					<div class="col-sm-4 col-xm-4" style="padding-bottom:5px">
						<input type="hidden" name="mp_2[]" id="mp_2[]" value="A33">
				...
				$rsResult = $conn->query("SELECT * FROM $schema2.`calon_stp_stam` WHERE `jenis_xm`='BT' AND `id_pemohon`=".tosql($uid). " AND tahun=".tosql($tahun2). " AND matapelajaran NOT IN ('A33')");
