<div class="form-group">
	<div class="row">
		<div class="col-sm-8">
			...
			<div class="form-group">
				<div class="row">
					<label for="nama" class="col-sm-4 control-label"><b>Tarikh Senat <font color="#FF0000">*</font><div style="float:right">:</div></b></label>
					<div class="col-sm-3"><input type="date" id="" name="" value="" class="form-control">
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
						<select name="peringkat1" id="peringkat1" class="form-control">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-2">
						<input type="text" name="cgpa1" id="cgpa1" class="form-control" value="<?=$rsUniv->fields['cgpa'];?>">
					</div>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
						<select name="inst_keluar_sijil1" id="inst_keluar_sijil1" class="form-control">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
						<select name="pengkhususan1" id="pengkhususan1" class="form-control">
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<select name="muet1" id="muet1" class="form-control">
							...
							<option value="Band 1" <?php if($rsUniv->fields['muet']=='Band 1'){ print 'selected'; }?>>Band 1</option>
							<option value="Band 2" <?php if($rsUniv->fields['muet']=='Band 2'){ print 'selected'; }?>>Band 2</option>
							<option value="Band 3" <?php if($rsUniv->fields['muet']=='Band 3'){ print 'selected'; }?>>Band 3</option>
							<option value="Band 4" <?php if($rsUniv->fields['muet']=='Band 4'){ print 'selected'; }?>>Band 4</option>
						</select>
					</div>
				</div>
			</div>
