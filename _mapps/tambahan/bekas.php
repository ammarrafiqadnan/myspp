		...
		<div class="panel-body">
			...
			<input type="hidden" name="id_pemohon" id="id_pemohon" value="<?php print $uid;?>" readonly="readonly"/>
				...
				<div class="col-md-12">
						  ...
						  <div class="card card-body">
								<label for="nama" class="col-sm-12 control-label"><b>ARAHAN : </b>
									<ul>
										...
										<li>Pesara Polis/Tentera yang menerima PENCEN, hanya boleh memohon jawatan bagi lantikan Kontrak/Sementara secara terus melalui Kementerian/Jabatan yang mempunyai kekosongan jawatan, tanpa perlu meneruskan permohonan dalam borang SPP.</li>
									</ul>
									<hr>
								</label>
					...
					<div class="form-group">
						<div class="row">
							<label for="nama" class="col-sm-2 control-label"><b>Kategori <div style="float:right">:</div></b></label>
							<div class="col-sm-4">
					...
					$pangkat=$rs_data->fields['pangkat'];
					$rujukan_ganjaran=$rs_data->fields['rujukan_ganjaran'];
					?>
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-8">
								<select class="form-control" name="pangkat" id="pangkat">
									...
									<option value="<?=$rsPangkat->fields['kod_pangkat'];?>" 
										<?php if($rsPangkat->fields['kod_pangkat']==$pangkat){ print 'selected'; } ?>><?=$rsPangkat->fields['diskripsi'];?></option>
					...
					<div class="form-group">
						<div class="row">
							<label for="nama" class="col-sm-2 control-label"><b> Pencen / Ganjaran  <div style="float:right">:</div></b></label>
							<div class="col-sm-3">
								<select class="form-control" name="ganjaran" id="ganjaran">
									<option value="">Sila pilih</option>
									<option value="1"<?php if($rujukan_ganjaran==1){ print 'selected'; } ?>>MENERIMA PENCEN</option>
									<option value="2"<?php if($rujukan_ganjaran==2){ print 'selected'; } ?>>MENERIMA GANJARAN</option>
								</select>
							</div>
						</div>
					</div>
