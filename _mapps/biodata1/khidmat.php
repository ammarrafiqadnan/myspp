				...
				<div class="col-md-12">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-3">
								<input type="date" name="d_lantikan_jpa" id="d_lantikan_jpa" class="form-control" value="<?php print $data['d_lantikan_jpa'];?>">
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-5">
								<select name="skim_sekarang" id="skim_sekarang" class="form-control select2 select2-accessible" onchange="get_gred(this.value)" 
					...
					<div class="form-group">
						<div class="row">
							<label for="nama" class="col-sm-7 control-label"><b>Tarikh Pengesahan ke Skim Perkhidmatan Sekarang (Jika Berkenaan)<div style="float:right"><img src="../images/info.gif" title="Contoh : Sekiranya gred jawatan anda adalah N22, sila isikan tarikh lantikan Gred N17"> :</div></b><br>
					...
					<div class="form-group">
						<div class="row">
							<label for="nama" class="col-sm-7 control-label"><b>Jenis Peperiksaan <!--<font color="#FF0000">*</font>-->
								<div style="float:right"><img src="../images/info.gif" title="Sila klik pada medan carian dan calon boleh menaip perkataan yang dikehendaki. Carian dibuat berdasarkan perkataan yang ditaip."> :</div></b></label>
							<div class="col-sm-5">
								<select name="jenis_xm" id="jenis_xm" class="form-control">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-3">
								<input type="date" name="d_lulus_kpsl" id="d_lulus_kpsl" class="form-control" value="<?php print $data['d_lulus_kpsl'];?>">
							</div>
						</div>
					</div>
