...
<section class="panel">
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000" size="3"><b>MAKLUMAT SENARAI JAWATAN YANG LAYAK DIPOHON</b></font></h6>
    </header>
    <div class="panel-body">
        <div class="box-body">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-3 control-label">JENIS BAKAT<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-9">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-3 control-label">KENYATAAN<font color="#FF0000">*</font> : </label>
                    <div class="col-sm-9">
