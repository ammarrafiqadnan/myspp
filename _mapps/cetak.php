...
if($prn=='WORD'){
	...
	header("content-disposition: attachment;filename=ejawi-".date(Ymd).".doc");
} else if($prn=='EXCEL'){
	header("Content-Type: application/vnd.ms-excel");
	header("Expires: 0");
	header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
	header("content-disposition: attachment;filename=ejawi-".date(Ymd).".xls");
}
?>
<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=windows-1252">
<title>e-Penyelidikan JAWI</title>
...
<div class="divFooter">
	<table width="97%" border=0>
		<tr>
			...
			<td align="right"><i>Sumber : Sistem e-Penyelidikan JAWI</i></td>
		</tr>
	</table>
	<!--<div>
