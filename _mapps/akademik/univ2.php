	...
	<div class="row">
		<div class="col-sm-8"><br>
			...
			<div class="form-group" id="selmajor1" name="selmajor1">
				<div class="row">
					<label for="major1" class="col-sm-4 control-label"><b>Major (Sekiranya ada)<div style="float:right">:</div></b></label>
					<div class="col-sm-8">
						<select name="major1" id="major1" class="form-control select2" style="width: 100%;" aria-hidden="true">
							<option value="" selected>Sila Pilih</option>
							<?php while(!$qrymajor->EOF){ ?>
							<option value="<?=$qrymajor->fields['KOD'];?>" <?php if($rsUniv2->fields['MAJOR']==$qrymajor->fields['KOD']){ print 'selected'; }?>>
			...
			<div class="form-group" id="selminor1" name="selminor1">
				<div class="row">
					<label for="minor1" class="col-sm-4 control-label"><b>Minor (Sekiranya ada)<div style="float:right">:</div></b></label>
					<div class="col-sm-8">
						<select name="minor1" id="minor1" class="form-control select2" style="width: 100%;" aria-hidden="true">
							<option value="">Sila pilih </option>
							<?php while(!$qryminor->EOF){ ?>
							<option value="<?=$qryminor->fields['KOD'];?>" <?php if($rsUniv2->fields['MINOR']==$qryminor->fields['KOD']){ print 'selected'; }?>>
		...
		<div class="col-sm-4" align="center" style="border: 2px solid black; padding: 10px; border-radius: 25px;">
			...
			<?php if(empty($rsSijil32->fields['sijil_nama'])){ 
				...
				$sijil_pic3 = "/var/www/upload/".$uid."/".$rsSijil32->fields['sijil_nama'];
			...
			?>
				...
				<a href="../view_doc_pemohon.php?id_pemohon=<?=$uid;?>&doc=<?=$rsSijil32->fields['sijil_nama'];?>" target="_blank" 
				onclick="return popitup('../view_doc_pemohon.php?id_pemohon=<?=$uid;?>&doc=<?=$rsSijil32->fields['sijil_nama'];?>')">
				<?=$rsSijil32->fields['sijil_nama'];?></a> 
