		...
		<div class="col-sm-8">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-2">
						<input type="text" name="cgpa2" id="cgpa2" class="form-control" value="<?=$rsUniv2->fields['cgpa'];?>">
					</div>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
						<select name="inst_keluar_sijil2" id="inst_keluar_sijil2" class="form-control select2 select2-accessible" style="width: 100%;" aria-hidden="true">
			...
			<?php if(empty($rsUniv2->fields['inst_francais'])){ $inst_francais2='T'; } else { $inst_francais2 = $rsUniv2->fields['inst_francais']; } ?>
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
						<input type="radio" name="inst_francais2" value="Y" <?php if($inst_francais2=='Y'){ print 'checked'; }?>> YA &nbsp; 
						<input type="radio" name="inst_francais2" value="T" <?php if($inst_francais2=='T'){ print 'checked'; }?>> TIDAK 
					</div>
				</div>
			</div>
			<?php if(empty($rsUniv2->fields['bidang'])){ $bidang2='S'; } else { $bidang2 = $rsUniv2->fields['bidang']; } ?>
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
						<input type="radio" name="bidang2" value="P" <?php if($bidang2=='P'){ print 'checked'; }?>> Pendidikan &nbsp; 
						<input type="radio" name="bidang2" value="B" <?php if($bidang2=='B'){ print 'checked'; }?>> Bukan Pendidikan &nbsp;
						<input type="radio" name="bidang2" value="S" <?php if($bidang2=='S'){ print 'checked'; }?>> Semua &nbsp; 
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
						<select name="pengkhususan2" id="pengkhususan2" class="form-control select2 select2-accessible" style="width: 100%;" aria-hidden="true">
            ...
            <div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
						<select name="muet2" id="muet2" class="form-control">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
						<select name="biasiswa2" id="biasiswa2" class="form-control">
