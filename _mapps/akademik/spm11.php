...
if($actions==2){
	print '..'.$_POST["spm_jenis_sijil_2"]."..";
	//$_SESSION['SESS_SPMSIJIL2']=$jsijil2;
	//$_SESSION['SESS_SPMSIJIL']=$jsijil1;
	if(!empty($data['spm_jenis_sijil_2'])){ 
		$jsijil2 = $data['spm_jenis_sijil_2']; 
	} else {
		$jsijil2=isset($_REQUEST["spm_jenis_sijil_2"])?$_REQUEST["spm_jenis_sijil_2"]:""; 
	}
...
print "<br>ACT:".$actions.":".$s_sijil.":".$s_tahun.":".$s_pangkat.":".$jsijil1.":".$jsijil2;
