...
if($frm=='SRP'){
	...
	if($pro=='ADD'){
		...
		//added by ham alteraxis 31072024
		...
		if(!empty($bil_keputusan1)){ 
			$sql = "UPDATE $schema2.`calon_ipt` SET `tahun`=".tosql($tahun1).", `peringkat`=".tosql($peringkat1).", `cgpa`=".tosql($cgpa1).", 
				...
				`d_kemaskini`=".tosql(date("Y-m-d H:i:s")).", `major`=".tosql($major1).", `minor`=".tosql($minor1)."
			WHERE `id_pemohon`=".tosql($id_pemohon)." AND `bil_keputusan`=1";
		} else {
			$sql = "INSERT INTO $schema2.`calon_ipt`(`id_pemohon`, `bil_keputusan`, `tahun`, `peringkat`, `cgpa`, `inst_keluar_sijil`, `inst_francais`, `bidang`, `pengkhususan`, `biasiswa`, `muet`, `muet_tahun`, `muet_gred`, `tkh_senate`, `major`, `minor` , `d_cipta`) 
			VALUES(".tosql($id_pemohon).", '1', ".tosql($tahun1).", ".tosql($peringkat1).", ".tosql($cgpa1).", ".tosql($inst_keluar_sijil1).", 
				...
				".tosql($muet1).", ".tosql($muet_tahun).", ".tosql($muet_gred).", ".tosql(DBDate($tkh_senate)).", 
				".tosql($major1).", ".tosql($minor1).", ".tosql(date("Y-m-d H:i:s")).")";
		}
		...
		$biasiswa1=isset($_REQUEST["biasiswa1"])?$_REQUEST["biasiswa1"]:"";
		$tkh_senate=isset($_REQUEST["tkh_senate"])?$_REQUEST["tkh_senate"]:"";
		//added by ham alteraxis 01082024
		$major1=isset($_REQUEST["major1"])?$_REQUEST["major1"]:"";
		$minor1=isset($_REQUEST["minor1"])?$_REQUEST["minor1"]:"";
		...
		if(!empty($bil_keputusan2)){ 
			...
			$sql = "INSERT INTO $schema2.`calon_ipt`(`id_pemohon`, `bil_keputusan`, `tahun`, `peringkat`, `cgpa`, `inst_keluar_sijil`, `inst_francais`, `bidang`, `pengkhususan`, `biasiswa`, `muet`, `muet_tahun`, `muet_gred`, `major`, `minor`, `tkh_senate` , `d_cipta`) 
			VALUES(".tosql($id_pemohon).", '2', ".tosql($tahun1).", ".tosql($peringkat1).", ".tosql($cgpa1).", ".tosql($inst_keluar_sijil1).", 
				...
				".tosql($major1).", ".tosql($minor1).", ".tosql(DBDate($tkh_senate)).", ".tosql(date("Y-m-d H:i:s")).")";
		}
