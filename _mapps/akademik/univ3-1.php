...
function save_univ(){
	var bil_keputusan3 = $('#bil_keputusan3').val();
    ...
    if(tahun1.trim() =='' && bil_keputusan3.trim() == ''){
		...
		<div class="col-sm-8">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-4"><input type="date" id="tkh_senate" name="tkh_senate" class="form-control" value="<?php print $rsUniv3->fields['tkh_senate'];?>">
					</div>
				</div>
			</div>
			<?php 
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-2">
						<input type="text" name="cgpa1" id="cgpa1" class="form-control" value="<?=$rsUniv3->fields['cgpa'];?>" 
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
						<select name="biasiswa1" id="biasiswa1" class="form-control">
