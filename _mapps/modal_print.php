...
<table border="0" align="center" cellpadding="1" cellspacing="0">
	<tr><td>
    	...
    	<!--<input type="button" value="Salin Ke Excel" onClick="do_pages('laporan_statistik_papar.php?prn=EXCEL')" style="cursor:pointer" />
    	<input type="button" value="Salin Ke MS Word" onClick="do_pages('laporan_statistik_papar.php?prn=WORD')" style="cursor:pointer" />-->
