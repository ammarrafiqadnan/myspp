			...
			<div class="box-body" style="background-color:#F2F2F2">
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead  style="background-color:rgb(38, 167, 228)">
                        ...
                        <th width="15%"><font color="#000000"><div align="center">Tajuk FAQ</div></font></th>
                        <th width="45%"><font color="#000000"><div align="center">Keterangan FAQ</div></font></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="" class="btn btn-md btn-success" data-toggle="modal" data-taraget="#myModal" title="Kemaskini Maklumat FAQ">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="" class="btn btn-md btn-danger" data-toggle="modal" data-taraget="#myModal" title="Hapus Maklumat FAQ">
