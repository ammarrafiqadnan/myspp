                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="index.php?data=<?php print base64_encode('pengurusan/parameter/domainEmail;Pentadbiran;Parameter;Domain Emel;;;'); ?>" class="btn btn-md btn-success" data-toggle="modal" data-taraget="#myModal" title="Kemaskini Maklumat Jawatan Berdasarkan Kelulusan">
                                    <i class="fa fa-edit"></i>
                                </a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="center">
                                <a href="index.php?data=<?php print base64_encode('pengurusan/parameter/matapelajaran;Pentadbiran;Parameter;Mata Pelajaran Maklumat Akademik;;;'); ?>" class="btn btn-md btn-success" data-toggle="modal" data-taraget="#myModal" title="Kemaskini Mata Pelajaran Maklumat Akademik">
                                    <i class="fa fa-edit"></i>
                                </a>
                            </td>
                        </tr>
