...
function do_close(){
    ...
    $("#Section2").load('maklumat_data/plik_form2.php');
    // $('.modal-input').val('');
    $('#myModal').modal('hide');
}
...
function do_save(){
    ...
    if(info_tarikh.trim() == '' ){
        ...
        $.ajax({
            url:'maklumat_data/sql_maklumat_data.php?frm=PLIK_INFO&pro=SAVE',
            type:'POST',
            //dataType: 'json',
            beforeSend: function () {
...
//print "ID:".$ids;
// $conn->debug=true;
$sql = "SELECT * FROM `tbl_plik_info` WHERE `id_pdetail`=".tosql($id_det);
$rsk = $conn->query($sql);
...
<section class="panel">
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000" size="3"><b>MAKLUMAT TAMBAHAN / PEMANTAUAN</b></font></h6>
    </header>
    <div class="panel-body">
        <div class="box-body">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="agensi_nama" class="col-sm-2 control-label">TARIKH <font color="#FF0000">*</font> : </label>
                    <div class="col-sm-3">
            ...
            <div class="form-group">
              <div class="row">
                <label for="agensi_nama" class="col-sm-2 control-label">JENIS MAKLUMAT <font color="#FF0000">*</font> : </label>
                <div class="col-sm-4">
                    <select class="form-control modal-input" name="info_jenis" id="info_jenis">
                        <option value="">Sila pilih</option>
                        <option value="P" <?php if($rsk->fields['info_jenis']=='P'){ print 'selected'; }?>>Pemantauan</option>
                        <option value="M" <?php if($rsk->fields['info_jenis']=='M'){ print 'selected'; }?>>Makluman</option>
                    </select>
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="row">
                <label for="agensi_nama" class="col-sm-2 control-label">KENYATAAN <font color="#FF0000">*</font> : </label>
                <div class="col-sm-10">
                    <textarea rows="6" class="form-control modal-input" name="info_kenyataan" id="info_kenyataan"><?php print $rsk->fields['info_kenyataan'];?></textarea>
                </div>
              </div>
            </div>
