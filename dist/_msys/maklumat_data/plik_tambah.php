...
function do_save(){
    ...
    var no_pasport = $('#no_pasport').val();
	
    if(no_pasport.trim() == '' ){
        alert('Sila masukkan nombor pasport pemegang pas.');
        $('#no_pasport').focus(); return false;
    } else {
        $.ajax({
            url:'maklumat_data/sql_maklumat_data.php?frm=PLIK_ADD',
			type:'POST',
            //dataType: 'json',
            beforeSend: function () {
...
<section class="panel">
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000" size="3"><b>TAMBAH MAKLUMAT PEMEGANG PAS LAWATAN IKHTISAS</b></font></h6>
    </header>
    <div class="panel-body">
        <div class="box-body">
            ...
            <div class="form-group">
              <div class="row">
                <label for="agensi_nama" class="col-sm-3 control-label">NO. PASSPORT : </label>
                <div class="col-sm-4">
                    <input type="text" name="no_pasport" id="no_pasport" class="form-control" />
                </div>
              </div>
            </div>
