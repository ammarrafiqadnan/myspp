...
function do_simpan(){
    ...
    if(password1.trim() == '' ){
        ...
        alert('Kata laluan anda tidak sama');
        $('#password2').focus(); return false;
	} else {
		if(password1.length <= 7){
			...
			if(password1.length>=8 && ucaseFlag && lcaseFlag && digitsFlag && splCharsFlag){
				...
				$.ajax({
					url:'utiliti/userpwd_form_sql.php?pro=SAVE', //&datas='+datas,
					type:'POST',
					//dataType: 'json',
					beforeSend: function () {
    ...
    <div class="panel-body">
        ...
        <div class="col-md-12">
			...
			<div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" name="emel" id="emel" class="form-control" readonly="readonly" 
