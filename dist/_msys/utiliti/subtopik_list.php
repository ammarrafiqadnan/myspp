...
function do_hapus(ID){
	swal({
		...
		$.ajax({
			url:'utiliti/topik_form_sql.php?pro=DEL&id='+ID, //&datas='+datas,
			type:'POST',
			//dataType: 'json',
			/*beforeSend: function () {
...
?>
		...
		<div class="box" style="background-color:#F2F2F2">
			...
			<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
                ...
                <h6 class="panel-title"><font color="#000000"><b>Maklumat Rujukan Sub Topik</b></font></h6> 
            </header>
			</div>
            </div>            
            <br />
                ...
                <div class="form-group">
        			...
        			<div class="col-md-4" align="right">
                        <button type="button" class="btn btn-success" 
                            ...
                            <a href="utiliti/subtopik_form.php" 
                            data-toggle="modal" data-target="#myModal"  
                            title="Tambah Maklumat Rujukan Sub topik" class="fa" data-backdrop="static">
			...
			<?php
			// $conn->debug=true;
            $sql = "SELECT * FROM `_ref_topik_sub` A, `_ref_topik` B WHERE A.topik_id=B.topik_id AND A.is_deleted=0 ";
            if(!empty($carian)){ $sql .= " AND subtopik_nama LIKE '%{$carian}%'"; }
            $sql .= " ORDER BY A.topik_id, A.subtopik_nama";
			?>    
            ...
            <div class="box-body">
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tr style="background-color:rgb(38, 167, 228)">
                  ...
                  <th width="50%"><font color="#000000"><div align="center">Maklumat Sub topik</div></font></th>
                  <th width="20%"><font color="#000000"><div align="center">Maklumat topik</div></font></th>
			...
			if(!$rs->EOF) {
				...
				while(!$rs->EOF){ 
					...
					$ids=$rs->fields['subtopik_id'];
					$subtopik_nama = str_replace($carian,'<font color="#FF0000">'.$carian.'</font>', $rs->fields['subtopik_nama']);
				?>
				  <tr>
					  <td align="center"><?=$bil;?></td>
					  <td align="left"><?php print $subtopik_nama;?></td>
					  <td align="center"><?php print $rs->fields['topik_nama'];?></td>
					  <td align="center" class="actions">
						<?php if(empty($rs->fields['subtopik_status'])){ ?>
					  ...
					  <td class="actions" align="center">
						  <a href="utiliti/subtopik_form.php?ids=<?=$ids;?>" 
							data-toggle="modal" data-target="#myModal"  
							title="Kemaskini maklumat sub topik" class="fa" data-backdrop="static" style="margin:0px;">
							...
							<button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('<?=$ids;?>')">
								<span style="cursor:pointer;color:red" title="Hapus maklumat rujukan sub topik">
