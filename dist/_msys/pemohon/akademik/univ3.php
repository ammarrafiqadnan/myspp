		...
		<div class="col-sm-8">
            ...
            <div class="form-group">
				<div class="row">
					...
					<div class="col-sm-8">
                        <?php if($rsUniv3->fields['muet']=='Band 1'){ print 'Band 1'; }?>
                        <?php if($rsUniv3->fields['muet']=='Band 2'){ print 'Band 2'; }?>
                        <?php if($rsUniv3->fields['muet']=='Band 3'){ print 'Band 3'; }?>
                        <?php if($rsUniv3->fields['muet']=='Band 4'){ print 'Band 4'; }?>
					</div>
				</div>
			</div>
			<div class="form-group">
