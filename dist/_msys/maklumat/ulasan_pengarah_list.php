...
<div class="box" style="background-color:#F2F2F2">
	...
	<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Maklumat Pemantauan - ULASAN PENGARAH JAWI</b></font></h6> 
    </header>
	</div>
    </div>            
    <br />
      	...
      	<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
			...
			<tr>
				...
				<td class="actions" align="center">
					<a href="maklumat/ulasan_pengarah_form.php?id=<?=$pemantauan_id;?>" data-toggle="modal" data-target="#myModal-xl" title="Ulasan Pengarah JAWI" class="fa" data-backdrop="">
		                <button type="button" class="btn btn-sm btn-success">
						<span style="cursor:pointer;color:red" title="Ulasan Pengarah JAWI">
