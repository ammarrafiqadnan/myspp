...
<link href="vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet"><script language="javascript">
...
<div class="box" style="background-color:#F2F2F2">
	...
	<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Maklumat Pemantauan</b></font></h6> 
    </header>
	</div>
    </div>            
    <br />
    <div class="box-body" style="background-color:#F2F2F2">
    	...
    	<?php } ?>
        <div class="col-md-2" style="background-color:#F2F2F2">
            <img src="images/printButton.png" title="Cetak" style="cursor:pointer" width="25" height="25" onclick="do_print('cetak.php?pages=maklumat/pemantauan_list_cetak&prn=')" />&nbsp;
            <img src="images/icon_office_excel.gif" title="Salin ke EXCEL" style="cursor:pointer" width="25" height="25" onclick="do_print('cetak.php?pages=maklumat/pemantauan_list_cetak&prn=EXCEL')" />&nbsp;
            <img src="images/icon_office_word.gif" title="Salin ke MS Word" style="cursor:pointer" width="25" height="25" onclick="do_print('cetak.php?pages=maklumat/pemantauan_list_cetak&prn=WORD')" />&nbsp;
        </div>
    </div> 
				...
				<td class="actions" align="center" bgcolor="<?=$bg;?>">
					...
					<?php if($_SESSION['SESS_ULEVEL']==2 || $_SESSION['SESS_ULEVEL']==3){ ?>
						<?php if($status_proses==0 || $status_proses==1){ ?>
					  		<a href="<?=$hrefs;?>"title="Kemaskini Maklumat Pemantauan"><label class="btn btn-sm btn-success"><i class="fa fa-edit" style="color:white;"></i></label></a>
					  		<?php if($status_proses==0){ ?>
								<button type="button" class="btn btn-sm btn-danger"  title="Hapus maklumat pemantauan"
									onclick="do_hapus('maklumat/sql_maklumat.php?frm=PANTAU&pro=DEL&ID=<?=$pemantauan_id;?>')">
									<span style="cursor:pointer;color:red" title="Hapus maklumat pemantauan">
						...
						<?php } ?>&nbsp;
					<?php } ?>
					<a href="maklumat/view_pemantauan.php?id=<?=$pemantauan_id;?>" data-toggle="modal" data-target="#myModal-xl" 
						title="Paparan Maklumat Pemantauan" class="fa" data-backdrop="">
		                <button type="button" class="btn btn-sm btn-info">
						<span style="cursor:pointer;color:red" title="Paparkan maklumat pemantauan"><i class="fa fa-eye" style="color: #FFFFFF;"></i></span>
						</button>
					</a>
