...
<div class="box" style="background-color:#F2F2F2">
	...
	<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Maklumat Laporan Isu Penghinaan Agama Di Media Massa</b></font></h6> 
    </header>
	</div>
    </div>            
    <br />
    <div class="box-body" style="background-color:#F2F2F2">
        ...
        <div class="col-md-2" style="background-color:#F2F2F2">
            <select name="topik_list" id="topik_list"  class="form-control" onchange="do_page('<?=$url;?>&T=N')">
                <option value="-">-- Semua jenis kluster --</option>
                <?php while(!$rsAkhbar->EOF){ ?>
                <option value="<?php print $rsAkhbar->fields['kluster_id'];?>" <?php if($rsAkhbar->fields['kluster_id']==$topik_list){ 
                    print 'selected'; }?>><?php print $rsAkhbar->fields['kluster_nama'];?></option>
        ...
        <div class="col-md-4" style="background-color:#F2F2F2">
            ...
            <?php if($_SESSION['SESS_ULEVEL']==2 || $_SESSION['SESS_ULEVEL']==3){ ?>
            	<a href="maklumat/isu_mediamassa_form.php" data-toggle="modal" data-target="#myModal" 
            		title="Tambah Maklumat Pemantauan" class="fa" data-backdrop="">
	                <button type="button" class="btn btn-primary">
	                <i class=" fa fa-plus-square"></i> <font style="font-family:Verdana, Geneva, sans-serif"> Tambah Maklumat</font></button>
				</a>&nbsp;
			<?php } ?>
            <img src="images/printButton.png" title="Cetak" style="cursor:pointer" width="25" height="25" onclick="do_print('cetak.php?pages=maklumat/isu_mediamassa_list_cetak&prn=')" />&nbsp;
            <img src="images/icon_office_excel.gif" title="Salin ke EXCEL" style="cursor:pointer" width="25" height="25" onclick="do_print('cetak.php?pages=maklumat/isu_mediamassa_list_cetak&prn=EXCEL')" />&nbsp;
            <img src="images/icon_office_word.gif" title="Salin ke MS Word" style="cursor:pointer" width="25" height="25" onclick="do_print('cetak.php?pages=maklumat/isu_mediamassa_list_cetak&prn=WORD')" />&nbsp;
        </div>
        <!-- <div class="col-md-2" style="background-color:#F2F2F2">
        </div> -->
    </div> 
    ...
    <div class="box-body" style="background-color:#F2F2F2">
		...
		?>
			<tr>
				...
				<td align="center">
					<table width="100%" cellpadding="5" cellspacing="1" border="1" class="table">
						<tr>
				...
				<td align="center" bgcolor="<?=$bg;?>">
					<a href="maklumat/isu_mediamassa_form.php?id=<?=$id;?>" data-toggle="modal" data-target="#myModal" title="Paparan Maklumat Pemantauan" class="fa" data-backdrop="">
