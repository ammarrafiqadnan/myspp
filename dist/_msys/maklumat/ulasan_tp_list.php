...
<div class="box" style="background-color:#F2F2F2">
	...
	<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Maklumat Pemantauan - ULASAN TIMBALAN PENGARAH (O)</b></font></h6> 
    </header>
	</div>
    </div>            
    <br />
    ...
    <div class="box-body" style="background-color:#F2F2F2">
      	<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
			...
			while(!$rs->EOF){ 
				...
				$status_ulasan = dlookup("tbl_pemantauan_ulasan","pid","jenis_ulasan=7 AND pemantauan_id=".tosql($pemantauan_id));
			?>
			<tr>
				...
				<td align="center">
					...
					<?php if(!empty($status_ulasan)){
						print '<i style="color:#f00">Kemaskini Laporan</i>';
					} ?>
				</td>
				<td class="actions" align="center">
					<a href="maklumat/ulasan_tp_form.php?id=<?=$pemantauan_id;?>" data-toggle="modal" data-target="#myModal-xl" title="Paparan Maklumat Pemantauan" class="fa" data-backdrop="">
		                <button type="button" class="btn btn-sm btn-success">
						<span style="cursor:pointer;color:red" title="Ulasan Timbalan Ketua Pengarah">
