...
<div class="box" style="background-color:#F2F2F2">
    ...
    <b>Maklumat Laporan Kajian Barang Gunaan Islam Meragukan</b>          
    ...
    <div class="box-body" style="background-color:#F2F2F2">
      	<table width="100%" cellpadding="5" cellspacing="0" border="1">
			...
			<tr>
				...
				<td align="left" valign="top"><?php print nl2br($rs->fields['subkat_nama']);?></td>
				<td align="left" valign="top"><?php print nl2br($rs->fields['tajuk']);?></td>
				<td align="left" valign="top"><?php print nl2br($rs->fields['tempat']);?></td>
				<td align="center" valign="top"><?php print $tarikh;?></td>
				<td align="center" valign="top"><?php print $status;?><br><?=$status_proses;?></td>
			</tr>
			<?php 
					$cnt = $cnt + 1;
					$bil = $bil + 1;
