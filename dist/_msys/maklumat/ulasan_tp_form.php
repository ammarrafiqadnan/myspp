...
function do_send(val1, val2){
	$.ajax({
        url:'maklumat/sql_maklumat.php?frm=ULASAN_TP&pro='+val1+'&act='+val2,
		type:'POST',
        //dataType: 'json',
        beforeSend: function () {
				...
				<div class="col-md-12">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-10">
								<textarea name="ulasan" id="ulasan" class="form-control" rows="6"><?php print $rsTP->fields['ulasan'];?></textarea>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-sm-5">
								<select name="status_proses" id="status_proses" class="form-control">
									...
									<option value="3">Dikembalikan kepada Ketua Bahagian</option>
									<option value="7">Hantar untuk semakan Pengarah</option>
								</select>
							</div>
						</div>
					</div>
					...
					<div class="modal-footer" style="padding:0px;">
						...
						<button type="button" class="btn btn-default" 
							onclick="do_page('index.php?data=<?php print base64_encode('maklumat/ulasan_tp_list;Ulasan Timbalan Pengarah;Ulasan Timbalan Pengarah;;;;'); ?>')">
