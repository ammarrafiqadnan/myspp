...
$url = "index.php?data=".base64_encode('maklumat/bahan_penerbitan_list;DATA;Laporan Kajian Bahan Penerbitan;;;;'); 
...
$pemantauan_types='11';
$href = "index.php?data=". base64_encode('maklumat/bahan_penerbitan_form;DATA;'.$menu.';;;');
?>
...
<div class="box" style="background-color:#F2F2F2">
	...
	<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000"><b>Maklumat Laporan Kajian Bahan Penerbitan Berunsur Islam Meragukan</b></font></h6> 
    </header>
	</div>
    </div>            
    <br />
    <div class="box-body" style="background-color:#F2F2F2">
    	...
    	<?php } ?>
        <div class="col-md-2" style="background-color:#F2F2F2">
            <img src="images/printButton.png" title="Cetak" style="cursor:pointer" width="25" height="25" onclick="do_print('cetak.php?pages=maklumat/bahan_penerbitan_cetak&prn=')" />&nbsp;
            <img src="images/icon_office_excel.gif" title="Salin ke EXCEL" style="cursor:pointer" width="25" height="25" onclick="do_print('cetak.php?pages=maklumat/bahan_penerbitan_cetak&prn=EXCEL')" />&nbsp;
            <img src="images/icon_office_word.gif" title="Salin ke MS Word" style="cursor:pointer" width="25" height="25" onclick="do_print('cetak.php?pages=maklumat/bahan_penerbitan_cetak&prn=WORD')" />&nbsp;
        </div>
    </div> 
    ...
    <div class="box-body" style="background-color:#F2F2F2">
      	<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
			...
			while(!$rs->EOF){ 
				...
				$hrefs = "index.php?data=". base64_encode('maklumat/bahan_penerbitan_form;DATA;'.$menu.';;;'.$pemantauan_id);
			...
			<tr>
				...
				<td class="actions" align="center" bgcolor="<?=$bg;?>">
					<?php if($_SESSION['SESS_ULEVEL']==2 || $_SESSION['SESS_ULEVEL']==3){ ?>
						<?php if($status_proses==0 || $status_proses==1){ ?>
					  		...
					  		<?php if($status_proses==0){ ?>
								<button type="button" class="btn btn-sm btn-danger"  title="Hapus maklumat kajian bahan penerbitan"
									onclick="do_hapus('maklumat/sql_maklumat.php?frm=BPENERBITAN&pro=DEL&ID=<?=$pemantauan_id;?>')">
									<span style="cursor:pointer;color:red" title="Hapus maklumat laporan Kajian bahan penerbitan">
					...
					<a href="maklumat/view_bahan_penerbitan.php?id=<?=$pemantauan_id;?>" data-toggle="modal" data-target="#myModal-xl" title="Paparan Maklumat Pemantauan" class="fa" data-backdrop="">
