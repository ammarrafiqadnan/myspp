...
function do_save(val1, val2){
    ...
    if(pemantauan_type.trim() == '' ){
        ...
        alert('Sila masukkan maklumat jenis bahan.');
	...
	} else if(pengeluar.trim() == '' ){
        alert('Sila masukkan maklumat pengeluar pemantauan.');
        $('#pengeluar').focus(); return false;
...
function do_prosessql(val1, val2){
	$.ajax({
        url:'maklumat/sql_maklumat.php?frm=BGUNAAN&pro='+val1+'&act='+val2,
		type:'POST',
        //dataType: 'json',
        beforeSend: function () {
...
<?php
$_SESSION['page_name']="BARANG GUNAAN";
// $conn->debug=true;
...
<div class="col-lg-12">
	<section class="panel">
		<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
			<h6 class="panel-title"><font color="#000000" size="3"><b>MAKLUMAT LAPORAN KAJIAN BARANG GUNAAN ISLAM YANG MERAGUKAN</b> - <i style="color:#f00">DRAF LAPORAN</i></font></h6>
		</header>
				...
				<div class="col-md-12">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-10">
								<textarea name="jenis" id="jenis" class="form-control"><?php print $rs->fields['material'];?></textarea>
								<!-- <input type="text" name="tajuk" id="tajuk" class="form-control" value="<?php print $rs->fields['tajuk'];?>" <?=$read_only;?>> -->
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-10">
								<textarea name="pengeluar" id="pengeluar" class="form-control"><?php print $rs->fields['pegawai'];?></textarea>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-10">
								<textarea name="laporan_kajian" id="laporan_kajian" class="form-control" rows="6"><?php print $rs->fields['laporan_kajian'];?></textarea>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-10">
								<textarea name="syor" id="syor" class="form-control" rows="6"><?php print $rs->fields['syor'];?></textarea>
							</div>
						</div>
					</div>
					...
					<div class="modal-footer" style="padding:0px;">
						...
						&nbsp;
						<button type="button" class="btn btn-default" onclick="do_page('index.php?data=<?php print base64_encode('maklumat/barang_gunaan_list;DATA;'.$menu.';;;;'); ?>')">
