...
<body>
<form name="veterina" id="veterina" class="bg-login" method="post" action="" enctype="multipart/form-data" autocomplete="off">
...
<?php include 'index_footer.php'; ?>  
    <div class="container-xxl py-1 text-center">
        <span style="font-size: 0.7em;">©2022 oleh Jabatan Perkhidmatan Veterinar.Semua hakcipta terpelihara.</span><br>
