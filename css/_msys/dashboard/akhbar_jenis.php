...
$rsD = $conn->query($sql);
while(!$rsD->EOF){
	$kategori = $rsD->fields['akhbar_nama'];
	$jumlah = dlookup("tbl_isu_agama","count(*)","is_deleted=0 AND `akhbar_id`=".tosql($rsD->fields['akhbar_id'])." AND year(tarikh)='{$tahun_list}' AND month(tarikh)='{$bulan_list}'");
...
<div class="box-body">
	<b>LAPORAN BERDASARKAN BULAN DAN JENIS AKHBAR</b> 
	<div class="row">
...
<script type="text/javascript">
    ...
    title: {
        text: 'LAPORAN BERDASARKAN BULAN DAN JENIS AKHBAR BAGI BULAN <?=$bulan_list;?> / <?=$tahun_list;?>'
    },
    // subtitle: {
    //     text: 'Source: ' +
