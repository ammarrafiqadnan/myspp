...
function do_send(val1, val2){
	$.ajax({
        url:'maklumat/sql_maklumat.php?frm=ULASAN&pro='+val1+'&act='+val2,
		type:'POST',
        //dataType: 'json',
        beforeSend: function () {
...
<?php
$_SESSION['page_name']="ULASAN KETUA BAHAGIAN";
// $conn->debug=true;
				...
				<div class="col-md-12">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-10">
								<textarea name="ulasan" id="ulasan" class="form-control" rows="6"><?php print $rsKB->fields['ulasan'];?></textarea>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="row">
							<label for="nama" class="col-sm-2 control-label"><b>ULASAN TIMBALAN KETUA PENGARAH <font color="#FF0000">*</font> : </b></label>
						...
						<div class="row">
							...
							<div class="col-sm-5">
								<select name="status_proses" id="status_proses" class="form-control">
									...
									<option value="1">Dikembalikan kepada pegawai pemantau</option>
									<option value="5">Hantar untuk semakan Timbalan Pengarah (O)</option>
								</select>
							</div>
						</div>
					</div>
					...
					<div class="modal-footer" style="padding:0px;">
						...
						<button type="button" class="btn btn-default" 
							onclick="do_page('index.php?data=<?php print base64_encode('maklumat/ulasan_kb_list;Ulasan Ketua Bahagian;Ulasan Ketua Bahagian;;;;'); ?>')">
