...
function do_del(id){
	swal({
		...
		e.preventDefault();
		$.ajax({
			url:'utiliti/isuagama_form_sql.php?pro=DEL&agid='+id, //&datas='+datas,
			type:'POST',
			//dataType: 'json',
			beforeSend: function () {
				$('.btn-primary').attr("disabled","disabled");
...
//print "ID:".$ids;
$sql = "SELECT * FROM _ref_isuagama WHERE isuagama_id=".tosql($ids);
$rsk = $conn->query($sql);
?>
<div class="col-lg-12">
<section class="panel">
    <header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
        ...
        <h6 class="panel-title"><font color="#000000" size="3"><b>MAKLUMAT RUJUKAN ISU AGAMA</b></font></h6>
    </header>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="isuagama_nama" id="isuagama_nama" class="form-control" value="<?php print $rsk->fields['isuagama_nama'];?>" />
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-6">
                    <select class="form-control" name="isuagama_status" id="isuagama_status" required="required">
                        <option value="0"<?php if($rsk->fields['isuagama_status']==0){ print 'selected';}?>>Rekod Aktif</option>
                        <option value="1"<?php if($rsk->fields['isuagama_status']==1){ print 'selected';}?>>Rekod Tidak Aktif</option>
                    </select>
                </div>
               </div>
            </div>
