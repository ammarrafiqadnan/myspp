...
?>
		...
		<div class="box" style="background-color:#F2F2F2">
			...
			<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
                ...
                <h6 class="panel-title"><font color="#000000"><b>Maklumat Rujukan Akhbar</b></font></h6> 
            </header>
			</div>
            </div>            
            <br />
                ...
                <div class="form-group">
        			...
        			<div class="col-md-4" align="right">
                        <button type="button" class="btn btn-success" 
                            ...
                            <a href="utiliti/akhbar_form.php" 
                            data-toggle="modal" data-target="#myModal"  
                            title="Tambah Maklumat Rujukan Jenis Akhbar" class="fa" data-backdrop="static">
			...
			<?php
			// $conn->debug=true;
            $sql = "SELECT * FROM _ref_akhbar WHERE is_deleted=0 ";
            if(!empty($carian)){ $sql .= " AND akhbar_nama LIKE '%{$carian}%'"; }
            $sql .= " ORDER BY akhbar_nama";
			?>    
			...
			if(!$rs->EOF) {
				...
				while(!$rs->EOF){ 
					...
					$ids=$rs->fields['akhbar_id'];
					$akhbar_nama = str_replace($carian,'<font color="#FF0000">'.$carian.'</font>', $rs->fields['akhbar_nama']);
				?>
				  <tr>
					  <td align="center"><?=$bil;?></td>
					  <td align="left"><?php print $akhbar_nama;?></td>
					  <td align="center" class="actions">
						<?php if(empty($rs->fields['akhbar_status'])){ ?>
					  ...
					  <td class="actions" align="center">
						  <a href="utiliti/akhbar_form.php?ids=<?=$ids;?>" 
							data-toggle="modal" data-target="#myModal"  
							title="Kemaskini maklumat akhbar" class="fa" data-backdrop="static" style="margin:0px;">
							...
							<button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('<?=$ids;?>')">
								<span style="cursor:pointer;color:red" title="Hapus maklumat rujukan akhbar">
