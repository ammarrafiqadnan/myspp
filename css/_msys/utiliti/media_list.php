...
?>
		...
		<div class="box" style="background-color:#F2F2F2">
			...
			<header class="panel-heading"  style="background-color:rgb(38, 167, 228)">
                ...
                <h6 class="panel-title"><font color="#000000"><b>Maklumat Rujukan Medium Media</b></font></h6> 
            </header>
			</div>
            </div>            
            <br />
                ...
                <div class="form-group">
        			...
        			<div class="col-md-4" align="right">
                        <button type="button" class="btn btn-success" 
                            ...
                            <a href="utiliti/media_form.php" 
                            data-toggle="modal" data-target="#myModal"  
                            title="Tambah Maklumat Rujukan Medium Media" class="fa" data-backdrop="static">
			...
			<?php
			// $conn->debug=true;
            $sql = "SELECT * FROM `_ref_medium_media` WHERE `is_deleted`=0 ";
            if(!empty($carian)){ $sql .= " AND medium_name LIKE '%{$carian}%'"; }
            $sql .= " ORDER BY medium_name";
			?>    
            ...
            <div class="box-body">
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tr style="background-color:rgb(38, 167, 228)">
                  ...
                  <th width="20%"><font color="#000000"><div align="center">Maklumat Rujukan</div></font></th>
                  <th width="50%"><font color="#000000"><div align="center">Maklumat Rujukan</div></font></th>
			...
			if(!$rs->EOF) {
				...
				while(!$rs->EOF){ 
					...
					$ids=$rs->fields['medium_id'];
					$akhbar_nama = str_replace($carian,'<font color="#FF0000">'.$carian.'</font>', $rs->fields['medium_name']);
				?>
				  <tr>
					  <td align="center"><?=$bil;?></td>
					  <td align="center"><?php print $rs->fields['medium_code'];?></td>
					  <td align="left"><?php print $akhbar_nama;?></td>
					  <td align="center" class="actions">
						<?php if(empty($rs->fields['medium_status'])){ ?>
					  ...
					  <td class="actions" align="center">
						  <a href="utiliti/media_form.php?ids=<?=$ids;?>" 
							data-toggle="modal" data-target="#myModal"  
							title="Kemaskini maklumat rujukan medium media" class="fa" data-backdrop="static" style="margin:0px;">
							...
							<button type="button" class="btn btn-sm btn-danger" onclick="do_hapus('<?=$ids;?>')">
								<span style="cursor:pointer;color:red" title="Hapus maklumat rujukan medium media">
